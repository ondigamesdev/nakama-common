...
type Channel struct {
	...
	Self *Presence `protobuf:"bytes,3,opt,name=self,proto3" json:"self,omitempty"`
...
func (x *Channel) GetPresences() []*Presence {
	if x != nil {
		return x.Presences
	}
	return nil
...
func (x *Channel) GetSelf() *Presence {
	if x != nil {
		return x.Self
	}
	return nil
...
func (x *ChannelMessageAck) GetChannelType() uint32 {
	if x != nil {
...
type ChannelPresenceEvent struct {
	...
	Joins []*Presence `protobuf:"bytes,2,rep,name=joins,proto3" json:"joins,omitempty"`
	// Presences leaving the channel as part of this event, if any.
	Leaves []*Presence `protobuf:"bytes,3,rep,name=leaves,proto3" json:"leaves,omitempty"`
	// The name of the chat room, or an empty string if this message was not sent through a chat room.
	RoomName string `protobuf:"bytes,4,opt,name=room_name,json=roomName,proto3" json:"room_name,omitempty"`
	// The ID of the group, or an empty string if this message was not sent through a group channel.
	GroupId string `protobuf:"bytes,5,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`
...
func (x *ChannelPresenceEvent) GetJoins() []*Presence {
	if x != nil {
		return x.Joins
	}
	return nil
...
func (x *ChannelPresenceEvent) GetLeaves() []*Presence {
	if x != nil {
		return x.Leaves
	}
	return nil
...
type Match struct {
	...
	Presences []*Presence `protobuf:"bytes,5,rep,name=presences,proto3" json:"presences,omitempty"`
	// A reference to the current user's presence in the match.
	Self *Presence `protobuf:"bytes,6,opt,name=self,proto3" json:"self,omitempty"`
	...
	// Cross-node mode for this match (0=relay, 1=direct-connect).
	CrossNodeMode int32 `protobuf:"varint,8,opt,name=cross_node_mode,json=crossNodeMode,proto3" json:"cross_node_mode,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Match) GetPresences() []*Presence {
	if x != nil {
		return x.Presences
	}
	return nil
...
func (x *Match) GetCrossNodeMode() int32 {
	if x != nil {
		return x.CrossNodeMode
	}
	return 0
}
...
func (x *MatchData) GetPresence() *Presence {
	if x != nil {
		return x.Presence
	}
	return nil
...
func (x *MatchDataSend) GetPresences() []*Presence {
	if x != nil {
		return x.Presences
	}
	return nil
...
func (x *MatchPresenceEvent) GetJoins() []*Presence {
	if x != nil {
		return x.Joins
	}
	return nil
...
func (x *MatchPresenceEvent) GetLeaves() []*Presence {
	if x != nil {
		return x.Leaves
	}
	return nil
...
func (x *MatchmakerAdd) GetRealmId() string {
	if x != nil {
		return x.RealmId
	}
	return ""
...
func (x *MatchmakerAdd) GetCohortId() string {
	if x != nil {
		return x.CohortId
	}
	return ""
...
type Party struct {
	...
	// Self.
	Self *Presence `protobuf:"bytes,5,opt,name=self,proto3" json:"self,omitempty"`
	// Leader.
	Leader *Presence `protobuf:"bytes,6,opt,name=leader,proto3" json:"leader,omitempty"`
	// All current party members.
	Presences []*Presence `protobuf:"bytes,7,rep,name=presences,proto3" json:"presences,omitempty"`
...
func (x *Party) GetLeader() *Presence {
	if x != nil {
		return x.Leader
	}
	return nil
...
func (x *Party) GetPresences() []*Presence {
	if x != nil {
		return x.Presences
	}
	return nil
...
func (x *PartyPromote) GetPresence() *Presence {
	if x != nil {
		return x.Presence
	}
	return nil
...
func (x *PartyLeader) GetPresence() *Presence {
	if x != nil {
		return x.Presence
	}
	return nil
...
func (x *PartyAccept) GetPresence() *Presence {
	if x != nil {
		return x.Presence
	}
	return nil
...
func (x *PartyRemove) GetPresence() *Presence {
	if x != nil {
		return x.Presence
	}
	return nil
...
func (x *PartyJoinRequest) GetPresences() []*Presence {
	if x != nil {
		return x.Presences
	}
	return nil
...
func (x *PartyData) GetPresence() *Presence {
	if x != nil {
		return x.Presence
	}
	return nil
...
func (x *PartyPresenceEvent) GetJoins() []*Presence {
	if x != nil {
		return x.Joins
	}
	return nil
...
func (x *PartyPresenceEvent) GetLeaves() []*Presence {
	if x != nil {
		return x.Leaves
	}
	return nil
...
func (x *Status) GetPresences() []*Presence {
	if x != nil {
		return x.Presences
	}
	return nil
...
// Start receiving status updates for some set of characters.
type StatusFollow struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Character IDs to follow.
...
func (x *StatusFollow) GetCharacterIds() []string {
	if x != nil {
...
func (x *StatusFollow) GetNames() []string {
	if x != nil {
		return x.Names
	}
	return nil
...
func (x *StatusPresenceEvent) GetJoins() []*Presence {
	if x != nil {
		return x.Joins
	}
	return nil
...
func (x *StatusPresenceEvent) GetLeaves() []*Presence {
	if x != nil {
		return x.Leaves
	}
	return nil
...
// Stop receiving status updates for some set of characters.
type StatusUnfollow struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Characters to unfollow.
	CharacterIds  []string `protobuf:"bytes,1,rep,name=character_ids,json=characterIds,proto3" json:"character_ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *StatusUnfollow) GetCharacterIds() []string {
	if x != nil {
		return x.CharacterIds
	}
	return nil
...
type StreamData struct {
	...
	// The sender, if any.
	Sender *Presence `protobuf:"bytes,2,opt,name=sender,proto3" json:"sender,omitempty"`
...
func (x *StreamData) GetSender() *Presence {
	if x != nil {
		return x.Sender
	}
	return nil
...
func (x *StreamPresenceEvent) GetJoins() []*Presence {
	if x != nil {
		return x.Joins
	}
	return nil
...
func (x *StreamPresenceEvent) GetLeaves() []*Presence {
	if x != nil {
		return x.Leaves
	}
	return nil
...
// A session presence associated to a stream, usually through a list operation or a join/leave event.
type Presence struct {
	...
	// The character name for display purposes.
...
func (x *Presence) GetPersistence() bool {
	if x != nil {
		return x.Persistence
	}
	return false
...
func (x *Presence) GetStatus() *wrapperspb.StringValue {
	if x != nil {
		return x.Status
	}
	return nil
...
func (x *Presence) GetCharacterId() string {
	if x != nil {
...
func (x *Presence) GetCharacterName() string {
	if x != nil {
...
type MatchmakerMatched_MatchmakerUser struct {
	...
	// The user's realm ID.
	RealmId string `protobuf:"bytes,7,opt,name=realm_id,json=realmId,proto3" json:"realm_id,omitempty"`
	// The user's cohort ID (if participating in cross-realm event).
	CohortId      string `protobuf:"bytes,8,opt,name=cohort_id,json=cohortId,proto3" json:"cohort_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MatchmakerMatched_MatchmakerUser) GetPresence() *Presence {
	if x != nil {
		return x.Presence
	}
	return nil
...
func (x *MatchmakerMatched_MatchmakerUser) GetRealmId() string {
	if x != nil {
		return x.RealmId
	}
	return ""
...
func (x *MatchmakerMatched_MatchmakerUser) GetCohortId() string {
	if x != nil {
		return x.CohortId
	}
	return ""
...
const file_realtime_proto_rawDesc = "" +
	...
	"\tpresences\x18\x02 \x03(\v2\x19.nakama.realtime.PresenceR\tpresences\x12-\n" +
	"\x04self\x18\x03 \x01(\v2\x19.nakama.realtime.PresenceR\x04self\x12\x1b\n" +
	...
	"\n" +
	"channel_id\x18\x01 \x01(\tR\tchannelId\"\xef\x03\n" +
	...
	"\vuser_id_two\x18\v \x01(\tR\tuserIdTwo\x12!\n" +
	"\fchannel_type\x18\f \x01(\rR\vchannelType\"M\n" +
	...
	"channel_id\x18\x01 \x01(\tR\tchannelId\x12\x1d\n" +
	"\n" +
	"message_id\x18\x02 \x01(\tR\tmessageId\"\x91\x02\n" +
	"\x14ChannelPresenceEvent\x12\x1d\n" +
	"\n" +
	"channel_id\x18\x01 \x01(\tR\tchannelId\x12/\n" +
	"\x05joins\x18\x02 \x03(\v2\x19.nakama.realtime.PresenceR\x05joins\x121\n" +
	"\x06leaves\x18\x03 \x03(\v2\x19.nakama.realtime.PresenceR\x06leaves\x12\x1b\n" +
	"\troom_name\x18\x04 \x01(\tR\broomName\x12\x19\n" +
	"\bgroup_id\x18\x05 \x01(\tR\agroupId\x12\x1e\n" +
	"\vuser_id_one\x18\x06 \x01(\tR\tuserIdOne\x12\x1e\n" +
	...
	"\x1aRUNTIME_FUNCTION_EXCEPTION\x10\a\"\xbb\x02\n" +
	"\x05Match\x12\x19\n" +
	...
	"\x04size\x18\x04 \x01(\x05R\x04size\x127\n" +
	"\tpresences\x18\x05 \x03(\v2\x19.nakama.realtime.PresenceR\tpresences\x12-\n" +
	"\x04self\x18\x06 \x01(\v2\x19.nakama.realtime.PresenceR\x04self\x12\x19\n" +
	"\bnode_url\x18\a \x01(\tR\anodeUrl\x12&\n" +
	"\x0fcross_node_mode\x18\b \x01(\x05R\rcrossNodeMode\"!\n" +
	"\vMatchCreate\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"\xa6\x01\n" +
	"\tMatchData\x12\x19\n" +
	"\bmatch_id\x18\x01 \x01(\tR\amatchId\x125\n" +
	"\bpresence\x18\x02 \x01(\v2\x19.nakama.realtime.PresenceR\bpresence\x12\x17\n" +
	"\aop_code\x18\x03 \x01(\x03R\x06opCode\x12\x12\n" +
	"\x04data\x18\x04 \x01(\fR\x04data\x12\x1a\n" +
	"\breliable\x18\x05 \x01(\bR\breliable\"\xac\x01\n" +
	...
	"\tpresences\x18\x04 \x03(\v2\x19.nakama.realtime.PresenceR\tpresences\x12\x1a\n" +
	...
	"\n" +
	"MatchLeave\x12\x19\n" +
	"\bmatch_id\x18\x01 \x01(\tR\amatchId\"\x93\x01\n" +
	"\x12MatchPresenceEvent\x12\x19\n" +
	"\bmatch_id\x18\x01 \x01(\tR\amatchId\x12/\n" +
	"\x05joins\x18\x02 \x03(\v2\x19.nakama.realtime.PresenceR\x05joins\x121\n" +
	"\x06leaves\x18\x03 \x03(\v2\x19.nakama.realtime.PresenceR\x06leaves\"\xaf\x04\n" +
	...
	"\x0ecount_multiple\x18\x06 \x01(\v2\x1b.google.protobuf.Int32ValueR\rcountMultiple\x12\x19\n" +
	"\brealm_id\x18\a \x01(\tR\arealmId\x12\x1b\n" +
	"\tcohort_id\x18\b \x01(\tR\bcohortId\x1aC\n" +
	"\x15StringPropertiesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1aD\n" +
	"\x16NumericPropertiesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x01R\x05value:\x028\x01\"\x8d\x06\n" +
	...
	"\x04self\x18\x05 \x01(\v21.nakama.realtime.MatchmakerMatched.MatchmakerUserR\x04self\x1a\x94\x04\n" +
	"\x0eMatchmakerUser\x125\n" +
	"\bpresence\x18\x01 \x01(\v2\x19.nakama.realtime.PresenceR\bpresence\x12\x19\n" +
	...
	"\x12numeric_properties\x18\x06 \x03(\v2H.nakama.realtime.MatchmakerMatched.MatchmakerUser.NumericPropertiesEntryR\x11numericProperties\x12\x19\n" +
	"\brealm_id\x18\a \x01(\tR\arealmId\x12\x1b\n" +
	"\tcohort_id\x18\b \x01(\tR\bcohortId\x1aC\n" +
	"\x15StringPropertiesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\rNotifications\x12>\n" +
	"\rnotifications\x18\x01 \x03(\v2\x18.nakama.api.NotificationR\rnotifications\"\x9a\x02\n" +
	"\x05Party\x12\x19\n" +
	"\bparty_id\x18\x01 \x01(\tR\apartyId\x12\x12\n" +
	"\x04open\x18\x02 \x01(\bR\x04open\x12\x16\n" +
	"\x06hidden\x18\x03 \x01(\bR\x06hidden\x12\x19\n" +
	"\bmax_size\x18\x04 \x01(\x05R\amaxSize\x12-\n" +
	"\x04self\x18\x05 \x01(\v2\x19.nakama.realtime.PresenceR\x04self\x121\n" +
	"\x06leader\x18\x06 \x01(\v2\x19.nakama.realtime.PresenceR\x06leader\x127\n" +
	"\tpresences\x18\a \x03(\v2\x19.nakama.realtime.PresenceR\tpresences\x12\x14\n" +
	...
	"\bparty_id\x18\x01 \x01(\tR\apartyId\x125\n" +
	"\bpresence\x18\x02 \x01(\v2\x19.nakama.realtime.PresenceR\bpresence\"_\n" +
	...
	"\bparty_id\x18\x01 \x01(\tR\apartyId\x125\n" +
	"\bpresence\x18\x02 \x01(\v2\x19.nakama.realtime.PresenceR\bpresence\"'\n" +
	"\n" +
	"PartyClose\x12\x19\n" +
	"\bparty_id\x18\x01 \x01(\tR\apartyId\"1\n" +
	"\x14PartyJoinRequestList\x12\x19\n" +
	"\bparty_id\x18\x01 \x01(\tR\apartyId\"f\n" +
	"\x10PartyJoinRequest\x12\x19\n" +
	"\bparty_id\x18\x01 \x01(\tR\apartyId\x127\n" +
	"\tpresences\x18\x02 \x03(\v2\x19.nakama.realtime.PresenceR\tpresences\"\xa1\x04\n" +
	...
	"\bparty_id\x18\x01 \x01(\tR\apartyId\x12\x16\n" +
	"\x06ticket\x18\x02 \x01(\tR\x06ticket\"\x8a\x01\n" +
	"\tPartyData\x12\x19\n" +
	"\bparty_id\x18\x01 \x01(\tR\apartyId\x125\n" +
	"\bpresence\x18\x02 \x01(\v2\x19.nakama.realtime.PresenceR\bpresence\x12\x17\n" +
	"\aop_code\x18\x03 \x01(\x03R\x06opCode\x12\x12\n" +
	...
	"\x05joins\x18\x02 \x03(\v2\x19.nakama.realtime.PresenceR\x05joins\x121\n" +
	"\x06leaves\x18\x03 \x03(\v2\x19.nakama.realtime.PresenceR\x06leaves\"\x06\n" +
	"\x04Ping\"\x06\n" +
	"\x04Pong\"A\n" +
	"\x06Status\x127\n" +
	"\tpresences\x18\x01 \x03(\v2\x19.nakama.realtime.PresenceR\tpresences\"I\n" +
	"\fStatusFollow\x12#\n" +
	"\rcharacter_ids\x18\x01 \x03(\tR\fcharacterIds\x12\x14\n" +
	"\x05names\x18\x02 \x03(\tR\x05names\"y\n" +
	"\x13StatusPresenceEvent\x12/\n" +
	"\x05joins\x18\x02 \x03(\v2\x19.nakama.realtime.PresenceR\x05joins\x121\n" +
	"\x06leaves\x18\x03 \x03(\v2\x19.nakama.realtime.PresenceR\x06leaves\"5\n" +
	"\x0eStatusUnfollow\x12#\n" +
	"\rcharacter_ids\x18\x01 \x03(\tR\fcharacterIds\"D\n" +
	"\fStatusUpdate\x124\n" +
	...
	"subcontext\x12\x14\n" +
	"\x05label\x18\x04 \x01(\tR\x05label\"\xa0\x01\n" +
	"\n" +
	"StreamData\x12/\n" +
	"\x06stream\x18\x01 \x01(\v2\x17.nakama.realtime.StreamR\x06stream\x121\n" +
	"\x06sender\x18\x02 \x01(\v2\x19.nakama.realtime.PresenceR\x06sender\x12\x12\n" +
	"\x04data\x18\x03 \x01(\tR\x04data\x12\x1a\n" +
	"\breliable\x18\x04 \x01(\bR\breliable\"\xaa\x01\n" +
	"\x13StreamPresenceEvent\x12/\n" +
	"\x06stream\x18\x01 \x01(\v2\x17.nakama.realtime.StreamR\x06stream\x12/\n" +
	"\x05joins\x18\x02 \x03(\v2\x19.nakama.realtime.PresenceR\x05joins\x121\n" +
	"\x06leaves\x18\x03 \x03(\v2\x19.nakama.realtime.PresenceR\x06leaves\"\x9b\x02\n" +
	"\bPresence\x12\x17\n" +
	...
	"\fcharacter_id\x18\a \x01(\tR\vcharacterId\x12%\n" +
	"\x0echaracter_name\x18\b \x01(\tR\rcharacterNameBl\n" +
...
var file_realtime_proto_goTypes = []any{
	...
	(*Presence)(nil),                         // 52: nakama.realtime.Presence
...
var file_realtime_proto_depIdxs = []int32{
	...
	52,  // 50: nakama.realtime.Channel.presences:type_name -> nakama.realtime.Presence
	52,  // 51: nakama.realtime.Channel.self:type_name -> nakama.realtime.Presence
	...
	52,  // 58: nakama.realtime.ChannelPresenceEvent.joins:type_name -> nakama.realtime.Presence
	52,  // 59: nakama.realtime.ChannelPresenceEvent.leaves:type_name -> nakama.realtime.Presence
	...
	52,  // 62: nakama.realtime.Match.presences:type_name -> nakama.realtime.Presence
	52,  // 63: nakama.realtime.Match.self:type_name -> nakama.realtime.Presence
	52,  // 64: nakama.realtime.MatchData.presence:type_name -> nakama.realtime.Presence
	52,  // 65: nakama.realtime.MatchDataSend.presences:type_name -> nakama.realtime.Presence
	54,  // 66: nakama.realtime.MatchJoin.metadata:type_name -> nakama.realtime.MatchJoin.MetadataEntry
	52,  // 67: nakama.realtime.MatchPresenceEvent.joins:type_name -> nakama.realtime.Presence
	52,  // 68: nakama.realtime.MatchPresenceEvent.leaves:type_name -> nakama.realtime.Presence
	...
	52,  // 75: nakama.realtime.Party.self:type_name -> nakama.realtime.Presence
	52,  // 76: nakama.realtime.Party.leader:type_name -> nakama.realtime.Presence
	52,  // 77: nakama.realtime.Party.presences:type_name -> nakama.realtime.Presence
	52,  // 78: nakama.realtime.PartyPromote.presence:type_name -> nakama.realtime.Presence
	52,  // 79: nakama.realtime.PartyLeader.presence:type_name -> nakama.realtime.Presence
	52,  // 80: nakama.realtime.PartyAccept.presence:type_name -> nakama.realtime.Presence
	52,  // 81: nakama.realtime.PartyRemove.presence:type_name -> nakama.realtime.Presence
	52,  // 82: nakama.realtime.PartyJoinRequest.presences:type_name -> nakama.realtime.Presence
	...
	52,  // 86: nakama.realtime.PartyData.presence:type_name -> nakama.realtime.Presence
	52,  // 87: nakama.realtime.PartyPresenceEvent.joins:type_name -> nakama.realtime.Presence
	52,  // 88: nakama.realtime.PartyPresenceEvent.leaves:type_name -> nakama.realtime.Presence
	52,  // 89: nakama.realtime.Status.presences:type_name -> nakama.realtime.Presence
	52,  // 90: nakama.realtime.StatusPresenceEvent.joins:type_name -> nakama.realtime.Presence
	52,  // 91: nakama.realtime.StatusPresenceEvent.leaves:type_name -> nakama.realtime.Presence
	...
	52,  // 94: nakama.realtime.StreamData.sender:type_name -> nakama.realtime.Presence
	49,  // 95: nakama.realtime.StreamPresenceEvent.stream:type_name -> nakama.realtime.Stream
	52,  // 96: nakama.realtime.StreamPresenceEvent.joins:type_name -> nakama.realtime.Presence
	52,  // 97: nakama.realtime.StreamPresenceEvent.leaves:type_name -> nakama.realtime.Presence
	67,  // 98: nakama.realtime.Presence.status:type_name -> google.protobuf.StringValue
	52,  // 99: nakama.realtime.MatchmakerMatched.MatchmakerUser.presence:type_name -> nakama.realtime.Presence
