...
const file_realtime_proto_rawDesc = "" +
	...
	"\x05joins\x18\x02 \x03(\v2\x1d.nakama.realtime.UserPresenceR\x05joins\x125\n" +
	"\x06leaves\x18\x03 \x03(\v2\x1d.nakama.realtime.UserPresenceR\x06leaves\"\xaf\x04\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x01R\x05value:\x028\x01\"\x91\x06\n" +
	...
	"\x04self\x18\x05 \x01(\v21.nakama.realtime.MatchmakerMatched.MatchmakerUserR\x04self\x1a\x98\x04\n" +
