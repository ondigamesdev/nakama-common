...
// The status of a realm, ordered by lifecycle progression.
type RealmStatus int32

const (
	// The realm is active and available for play.
	RealmStatus_REALM_STATUS_ACTIVE RealmStatus = 0
	// The realm is announced but not yet open for play.
	RealmStatus_REALM_STATUS_COMING_SOON RealmStatus = 1
	// The realm is temporarily unavailable for maintenance.
	RealmStatus_REALM_STATUS_MAINTENANCE RealmStatus = 2
	// The realm is locked: existing players can play, but no new players or transfers in.
	RealmStatus_REALM_STATUS_LOCKED RealmStatus = 3
	// The realm is winding down: transfers out allowed, no new activity.
	RealmStatus_REALM_STATUS_RETIRING RealmStatus = 4
	// The realm is permanently closed and can be deleted.
	RealmStatus_REALM_STATUS_RETIRED RealmStatus = 5
)

// Enum value maps for RealmStatus.
var (
	RealmStatus_name = map[int32]string{
		0: "REALM_STATUS_ACTIVE",
		1: "REALM_STATUS_COMING_SOON",
		2: "REALM_STATUS_MAINTENANCE",
		3: "REALM_STATUS_LOCKED",
		4: "REALM_STATUS_RETIRING",
		5: "REALM_STATUS_RETIRED",
	}
	RealmStatus_value = map[string]int32{
		"REALM_STATUS_ACTIVE":      0,
		"REALM_STATUS_COMING_SOON": 1,
		"REALM_STATUS_MAINTENANCE": 2,
		"REALM_STATUS_LOCKED":      3,
		"REALM_STATUS_RETIRING":    4,
		"REALM_STATUS_RETIRED":     5,
	}
)
...
const (
	// The character is active and playable.
	CharacterStatus_CHARACTER_STATUS_ACTIVE CharacterStatus = 0
	// The character is banned.
	CharacterStatus_CHARACTER_STATUS_BANNED CharacterStatus = 1
	// The character is deleted.
	CharacterStatus_CHARACTER_STATUS_DELETED CharacterStatus = 2
	// The character is locked (e.g., during transfer).
	CharacterStatus_CHARACTER_STATUS_LOCKED CharacterStatus = 3
)

// Enum value maps for CharacterStatus.
var (
	CharacterStatus_name = map[int32]string{
		0: "CHARACTER_STATUS_ACTIVE",
		1: "CHARACTER_STATUS_BANNED",
		2: "CHARACTER_STATUS_DELETED",
		3: "CHARACTER_STATUS_LOCKED",
	}
	CharacterStatus_value = map[string]int32{
		"CHARACTER_STATUS_ACTIVE":  0,
		"CHARACTER_STATUS_BANNED":  1,
		"CHARACTER_STATUS_DELETED": 2,
		"CHARACTER_STATUS_LOCKED":  3,
	}
)
...
// The status of a character transfer.
type CharacterTransferStatus int32

const (
	// The transfer is pending approval or processing.
	CharacterTransferStatus_CHARACTER_TRANSFER_STATUS_PENDING CharacterTransferStatus = 0
	// The transfer is currently being processed.
	CharacterTransferStatus_CHARACTER_TRANSFER_STATUS_IN_PROGRESS CharacterTransferStatus = 1
	// The transfer completed successfully.
	CharacterTransferStatus_CHARACTER_TRANSFER_STATUS_COMPLETED CharacterTransferStatus = 2
	// The transfer failed.
...
var (
	CharacterTransferStatus_name = map[int32]string{
		0: "CHARACTER_TRANSFER_STATUS_PENDING",
		1: "CHARACTER_TRANSFER_STATUS_IN_PROGRESS",
...
func (x CharacterTransferStatus) Enum() *CharacterTransferStatus {
	p := new(CharacterTransferStatus)
	*p = x
	return p
}

func (x CharacterTransferStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CharacterTransferStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_api_proto_enumTypes[5].Descriptor()
}

func (CharacterTransferStatus) Type() protoreflect.EnumType {
	return &file_api_proto_enumTypes[5]
}

func (x CharacterTransferStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CharacterTransferStatus.Descriptor instead.
func (CharacterTransferStatus) EnumDescriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{5}
}

// Who initiated the character transfer.
type CharacterTransferInitiator int32

const (
	// The user requested the transfer.
	CharacterTransferInitiator_CHARACTER_TRANSFER_INITIATOR_USER CharacterTransferInitiator = 0
	// An admin initiated the transfer.
	CharacterTransferInitiator_CHARACTER_TRANSFER_INITIATOR_ADMIN CharacterTransferInitiator = 1
)

// Enum value maps for CharacterTransferInitiator.
var (
	CharacterTransferInitiator_name = map[int32]string{
		0: "CHARACTER_TRANSFER_INITIATOR_USER",
		1: "CHARACTER_TRANSFER_INITIATOR_ADMIN",
	}
	CharacterTransferInitiator_value = map[string]int32{
		"CHARACTER_TRANSFER_INITIATOR_USER":  0,
		"CHARACTER_TRANSFER_INITIATOR_ADMIN": 1,
	}
)

func (x CharacterTransferInitiator) Enum() *CharacterTransferInitiator {
	p := new(CharacterTransferInitiator)
	*p = x
	return p
}

func (x CharacterTransferInitiator) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CharacterTransferInitiator) Descriptor() protoreflect.EnumDescriptor {
	return file_api_proto_enumTypes[6].Descriptor()
}

func (CharacterTransferInitiator) Type() protoreflect.EnumType {
	return &file_api_proto_enumTypes[6]
}

func (x CharacterTransferInitiator) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CharacterTransferInitiator.Descriptor instead.
func (CharacterTransferInitiator) EnumDescriptor() ([]byte, []int) {
...
const (
	// Single realm maintenance.
	MaintenanceScope_MAINTENANCE_SCOPE_REALM MaintenanceScope = 0
	// Realm group maintenance (e.g., all EU servers).
	MaintenanceScope_MAINTENANCE_SCOPE_GROUP MaintenanceScope = 1
	// Global maintenance (all realms).
	MaintenanceScope_MAINTENANCE_SCOPE_GLOBAL MaintenanceScope = 2
)

// Enum value maps for MaintenanceScope.
var (
	MaintenanceScope_name = map[int32]string{
		0: "MAINTENANCE_SCOPE_REALM",
		1: "MAINTENANCE_SCOPE_GROUP",
		2: "MAINTENANCE_SCOPE_GLOBAL",
	}
	MaintenanceScope_value = map[string]int32{
		"MAINTENANCE_SCOPE_REALM":  0,
		"MAINTENANCE_SCOPE_GROUP":  1,
		"MAINTENANCE_SCOPE_GLOBAL": 2,
	}
)

func (x MaintenanceScope) Enum() *MaintenanceScope {
	p := new(MaintenanceScope)
	*p = x
	return p
}

func (x MaintenanceScope) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MaintenanceScope) Descriptor() protoreflect.EnumDescriptor {
	return file_api_proto_enumTypes[7].Descriptor()
}

func (MaintenanceScope) Type() protoreflect.EnumType {
	return &file_api_proto_enumTypes[7]
}

func (x MaintenanceScope) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MaintenanceScope.Descriptor instead.
func (MaintenanceScope) EnumDescriptor() ([]byte, []int) {
...
const (
	// Maintenance is scheduled but not yet active.
	MaintenanceStatus_MAINTENANCE_STATUS_SCHEDULED MaintenanceStatus = 0
	// Maintenance is currently active.
	MaintenanceStatus_MAINTENANCE_STATUS_ACTIVE MaintenanceStatus = 1
	// Maintenance has completed normally.
	MaintenanceStatus_MAINTENANCE_STATUS_COMPLETED MaintenanceStatus = 2
	// Maintenance was cancelled before completion.
	MaintenanceStatus_MAINTENANCE_STATUS_CANCELLED MaintenanceStatus = 3
)

// Enum value maps for MaintenanceStatus.
var (
	MaintenanceStatus_name = map[int32]string{
		0: "MAINTENANCE_STATUS_SCHEDULED",
		1: "MAINTENANCE_STATUS_ACTIVE",
		2: "MAINTENANCE_STATUS_COMPLETED",
		3: "MAINTENANCE_STATUS_CANCELLED",
	}
	MaintenanceStatus_value = map[string]int32{
		"MAINTENANCE_STATUS_SCHEDULED": 0,
		"MAINTENANCE_STATUS_ACTIVE":    1,
		"MAINTENANCE_STATUS_COMPLETED": 2,
		"MAINTENANCE_STATUS_CANCELLED": 3,
	}
)
...
// Status of a mailbox entry. Mirrors PamOps repository/mailbox.go states
// (Unread, Read, Claiming, Claimed, Expired, Deleted), offset by +1 for the
// UNSPECIFIED=0 convention.
type MailboxStatus int32

const (
	MailboxStatus_MAILBOX_STATUS_UNSPECIFIED MailboxStatus = 0
	MailboxStatus_MAILBOX_STATUS_UNREAD      MailboxStatus = 1 // PamOps Unread
	MailboxStatus_MAILBOX_STATUS_READ        MailboxStatus = 2 // PamOps Read
	MailboxStatus_MAILBOX_STATUS_CLAIMING    MailboxStatus = 3 // PamOps Claiming (async grant in-flight)
	MailboxStatus_MAILBOX_STATUS_CLAIMED     MailboxStatus = 4 // PamOps Claimed
	MailboxStatus_MAILBOX_STATUS_EXPIRED     MailboxStatus = 5 // PamOps Expired
	MailboxStatus_MAILBOX_STATUS_DELETED     MailboxStatus = 6 // PamOps Deleted (soft-delete)
)
...
var (
	MailboxStatus_name = map[int32]string{
		...
		1: "MAILBOX_STATUS_UNREAD",
		2: "MAILBOX_STATUS_READ",
		3: "MAILBOX_STATUS_CLAIMING",
		4: "MAILBOX_STATUS_CLAIMED",
		5: "MAILBOX_STATUS_EXPIRED",
		6: "MAILBOX_STATUS_DELETED",
	}
	MailboxStatus_value = map[string]int32{
		"MAILBOX_STATUS_UNSPECIFIED": 0,
		"MAILBOX_STATUS_UNREAD":      1,
		"MAILBOX_STATUS_READ":        2,
		"MAILBOX_STATUS_CLAIMING":    3,
		"MAILBOX_STATUS_CLAIMED":     4,
		"MAILBOX_STATUS_EXPIRED":     5,
		"MAILBOX_STATUS_DELETED":     6,
	}
)
...
// Category of a mailbox entry.
// NOTE: this is a deliberate client-contract SIMPLIFICATION. PamOps supports 7
// message types (reward, announcement, promotion, compensation, event, milestone,
// custom). The client only needs to distinguish the three below; any other PamOps
// type maps to MAILBOX_MESSAGE_TYPE_UNSPECIFIED via mapMessageType.
// If the client later needs the full set, expand this enum and mapMessageType together.
type MailboxMessageType int32

const (
	MailboxMessageType_MAILBOX_MESSAGE_TYPE_UNSPECIFIED  MailboxMessageType = 0
	MailboxMessageType_MAILBOX_MESSAGE_TYPE_SYSTEM       MailboxMessageType = 1
	MailboxMessageType_MAILBOX_MESSAGE_TYPE_REWARD       MailboxMessageType = 2
	MailboxMessageType_MAILBOX_MESSAGE_TYPE_ANNOUNCEMENT MailboxMessageType = 3
)

// Enum value maps for MailboxMessageType.
var (
	MailboxMessageType_name = map[int32]string{
		0: "MAILBOX_MESSAGE_TYPE_UNSPECIFIED",
		1: "MAILBOX_MESSAGE_TYPE_SYSTEM",
		2: "MAILBOX_MESSAGE_TYPE_REWARD",
		3: "MAILBOX_MESSAGE_TYPE_ANNOUNCEMENT",
	}
	MailboxMessageType_value = map[string]int32{
		"MAILBOX_MESSAGE_TYPE_UNSPECIFIED":  0,
		"MAILBOX_MESSAGE_TYPE_SYSTEM":       1,
		"MAILBOX_MESSAGE_TYPE_REWARD":       2,
		"MAILBOX_MESSAGE_TYPE_ANNOUNCEMENT": 3,
	}
)

func (x MailboxMessageType) Enum() *MailboxMessageType {
	p := new(MailboxMessageType)
	*p = x
	return p
}

func (x MailboxMessageType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MailboxMessageType) Descriptor() protoreflect.EnumDescriptor {
	return file_api_proto_enumTypes[10].Descriptor()
}

func (MailboxMessageType) Type() protoreflect.EnumType {
	return &file_api_proto_enumTypes[10]
}

func (x MailboxMessageType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MailboxMessageType.Descriptor instead.
func (MailboxMessageType) EnumDescriptor() ([]byte, []int) {
...
const (
	// The character is a friend of the current character.
	Friend_FRIEND Friend_State = 0
	// The current character has sent an invite to the character.
	Friend_INVITE_SENT Friend_State = 1
	// The current character has received an invite from this character.
	Friend_INVITE_RECEIVED Friend_State = 2
	// The current character has blocked this character.
...
type GroupCharacterList_GroupCharacter_State int32

const (
	// The character is a superadmin with full control of the group.
	GroupCharacterList_GroupCharacter_SUPERADMIN GroupCharacterList_GroupCharacter_State = 0
	// The character is an admin with additional privileges.
	GroupCharacterList_GroupCharacter_ADMIN GroupCharacterList_GroupCharacter_State = 1
	// The character is a regular member.
	GroupCharacterList_GroupCharacter_MEMBER GroupCharacterList_GroupCharacter_State = 2
	// The character has requested to join the group
	GroupCharacterList_GroupCharacter_JOIN_REQUEST GroupCharacterList_GroupCharacter_State = 3
)

// Enum value maps for GroupCharacterList_GroupCharacter_State.
var (
	GroupCharacterList_GroupCharacter_State_name = map[int32]string{
		0: "SUPERADMIN",
		1: "ADMIN",
		2: "MEMBER",
		3: "JOIN_REQUEST",
	}
	GroupCharacterList_GroupCharacter_State_value = map[string]int32{
		"SUPERADMIN":   0,
		"ADMIN":        1,
		"MEMBER":       2,
		"JOIN_REQUEST": 3,
...
func (x GroupCharacterList_GroupCharacter_State) Enum() *GroupCharacterList_GroupCharacter_State {
	p := new(GroupCharacterList_GroupCharacter_State)
	*p = x
	return p
}

func (x GroupCharacterList_GroupCharacter_State) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GroupCharacterList_GroupCharacter_State) Descriptor() protoreflect.EnumDescriptor {
	return file_api_proto_enumTypes[12].Descriptor()
}

func (GroupCharacterList_GroupCharacter_State) Type() protoreflect.EnumType {
	return &file_api_proto_enumTypes[12]
}

func (x GroupCharacterList_GroupCharacter_State) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GroupCharacterList_GroupCharacter_State.Descriptor instead.
func (GroupCharacterList_GroupCharacter_State) EnumDescriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{48, 0, 0}
}

// The group role status.
type CharacterGroupList_CharacterGroup_State int32

const (
	// The character is a superadmin with full control of the group.
	CharacterGroupList_CharacterGroup_SUPERADMIN CharacterGroupList_CharacterGroup_State = 0
	// The character is an admin with additional privileges.
	CharacterGroupList_CharacterGroup_ADMIN CharacterGroupList_CharacterGroup_State = 1
	// The character is a regular member.
	CharacterGroupList_CharacterGroup_MEMBER CharacterGroupList_CharacterGroup_State = 2
	// The character has requested to join the group
	CharacterGroupList_CharacterGroup_JOIN_REQUEST CharacterGroupList_CharacterGroup_State = 3
)

// Enum value maps for CharacterGroupList_CharacterGroup_State.
var (
	CharacterGroupList_CharacterGroup_State_name = map[int32]string{
		0: "SUPERADMIN",
		1: "ADMIN",
		2: "MEMBER",
		3: "JOIN_REQUEST",
	}
	CharacterGroupList_CharacterGroup_State_value = map[string]int32{
		"SUPERADMIN":   0,
		"ADMIN":        1,
		"MEMBER":       2,
		"JOIN_REQUEST": 3,
...
func (x CharacterGroupList_CharacterGroup_State) Enum() *CharacterGroupList_CharacterGroup_State {
	p := new(CharacterGroupList_CharacterGroup_State)
	*p = x
	return p
}

func (x CharacterGroupList_CharacterGroup_State) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CharacterGroupList_CharacterGroup_State) Descriptor() protoreflect.EnumDescriptor {
	return file_api_proto_enumTypes[13].Descriptor()
}

func (CharacterGroupList_CharacterGroup_State) Type() protoreflect.EnumType {
	return &file_api_proto_enumTypes[13]
}

func (x CharacterGroupList_CharacterGroup_State) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CharacterGroupList_CharacterGroup_State.Descriptor instead.
func (CharacterGroupList_CharacterGroup_State) EnumDescriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{97, 0, 0}
}
...
type Account struct {
	...
	// Emails associated with each authentication provider. Keys are provider names (e.g. "google", "apple", "email"), values are email addresses.
	AuthEmails    map[string]string `protobuf:"bytes,8,rep,name=auth_emails,json=authEmails,proto3" json:"auth_emails,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *Account) GetAuthEmails() map[string]string {
	if x != nil {
		return x.AuthEmails
	}
	return nil
...
// Add one or more friends to the current character.
...
func (x *AddFriendsRequest) GetNames() []string {
	if x != nil {
		return x.Names
	}
	return nil
...
type AddGroupCharactersRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The group to add characters to.
...
func (x *AddGroupCharactersRequest) Reset() {
	*x = AddGroupCharactersRequest{}
	mi := &file_api_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AddGroupCharactersRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AddGroupCharactersRequest) ProtoMessage() {}

func (x *AddGroupCharactersRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AddGroupCharactersRequest.ProtoReflect.Descriptor instead.
func (*AddGroupCharactersRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{12}
}

func (x *AddGroupCharactersRequest) GetGroupId() string {
	if x != nil {
		return x.GroupId
	}
	return ""
...
func (x *AddGroupCharactersRequest) GetCharacterIds() []string {
	if x != nil {
...
// Request an OTP code be sent to an email address for authentication or verification.
...
func (x *RequestEmailCodeRequest) Reset() {
	*x = RequestEmailCodeRequest{}
	mi := &file_api_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RequestEmailCodeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RequestEmailCodeRequest) ProtoMessage() {}

func (x *RequestEmailCodeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[24]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RequestEmailCodeRequest.ProtoReflect.Descriptor instead.
func (*RequestEmailCodeRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{24}
}

func (x *RequestEmailCodeRequest) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
// Authenticate against the server with an email OTP code.
type AuthenticateEmailOTPRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The email address used to request the code.
	Email string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`
...
func (x *AuthenticateEmailOTPRequest) Reset() {
	*x = AuthenticateEmailOTPRequest{}
	mi := &file_api_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AuthenticateEmailOTPRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuthenticateEmailOTPRequest) ProtoMessage() {}

func (x *AuthenticateEmailOTPRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[25]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuthenticateEmailOTPRequest.ProtoReflect.Descriptor instead.
func (*AuthenticateEmailOTPRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{25}
}

func (x *AuthenticateEmailOTPRequest) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *AuthenticateEmailOTPRequest) GetCode() string {
	if x != nil {
		return x.Code
	}
	return ""
...
func (x *AuthenticateEmailOTPRequest) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *AuthenticateEmailOTPRequest) GetVars() map[string]string {
	if x != nil {
		return x.Vars
	}
	return nil
...
// Verify email ownership with a code sent to the email address.
...
// Link an email address to an existing account using an OTP code.
type LinkEmailOTPRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *LinkEmailOTPRequest) Reset() {
	*x = LinkEmailOTPRequest{}
	mi := &file_api_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *LinkEmailOTPRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LinkEmailOTPRequest) ProtoMessage() {}

func (x *LinkEmailOTPRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[27]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LinkEmailOTPRequest.ProtoReflect.Descriptor instead.
func (*LinkEmailOTPRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{27}
}

func (x *LinkEmailOTPRequest) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *LinkEmailOTPRequest) GetCode() string {
	if x != nil {
		return x.Code
	}
	return ""
...
// Ban characters from a group.
type BanGroupCharactersRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The group to ban characters from.
	GroupId string `protobuf:"bytes,1,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`
	// The characters to ban.
	CharacterIds  []string `protobuf:"bytes,2,rep,name=character_ids,json=characterIds,proto3" json:"character_ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BanGroupCharactersRequest) Reset() {
	*x = BanGroupCharactersRequest{}
	mi := &file_api_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BanGroupCharactersRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BanGroupCharactersRequest) ProtoMessage() {}

func (x *BanGroupCharactersRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[28]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BanGroupCharactersRequest.ProtoReflect.Descriptor instead.
func (*BanGroupCharactersRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{28}
}

func (x *BanGroupCharactersRequest) GetGroupId() string {
	if x != nil {
		return x.GroupId
	}
	return ""
...
func (x *BanGroupCharactersRequest) GetCharacterIds() []string {
	if x != nil {
		return x.CharacterIds
	}
	return nil
...
// Block one or more friends for the current character.
...
func (x *BlockFriendsRequest) GetNames() []string {
	if x != nil {
		return x.Names
	}
	return nil
...
type ChannelMessage struct {
	...
	// The scope type for this message: 0 = global, 1 = realm, 2 = cohort.
	ScopeType uint32 `protobuf:"varint,14,opt,name=scope_type,json=scopeType,proto3" json:"scope_type,omitempty"`
...
func (x *ChannelMessage) GetScopeType() uint32 {
	if x != nil {
		return x.ScopeType
	}
	return 0
...
func (x *ChannelMessage) GetRealmId() string {
	if x != nil {
		return x.RealmId
	}
	return ""
...
type CreateGroupRequest struct {
	...
	// Scope type: 0=global (uses caller's realm context if available), 1=realm (requires realm context).
	// When not specified, defaults based on caller's realm context.
	ScopeType     uint32 `protobuf:"varint,7,opt,name=scope_type,json=scopeType,proto3" json:"scope_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateGroupRequest) GetScopeType() uint32 {
	if x != nil {
		return x.ScopeType
	}
	return 0
...
// Delete one or more friends for the current character.
...
func (x *DeleteFriendsRequest) GetNames() []string {
	if x != nil {
		return x.Names
	}
	return nil
...
func (x *DeleteStorageObjectId) GetCharacterId() string {
	if x != nil {
		return x.CharacterId
	}
	return ""
...
func (x *Friend) GetCharacter() *Character {
	if x != nil {
		return x.Character
	}
	return nil
...
type Group struct {
	...
	ScopeType uint32 `protobuf:"varint,13,opt,name=scope_type,json=scopeType,proto3" json:"scope_type,omitempty"`
	// The realm ID if this group is realm-scoped.
	RealmId string `protobuf:"bytes,14,opt,name=realm_id,json=realmId,proto3" json:"realm_id,omitempty"`
	// The cohort ID if this group is cohort-scoped.
...
func (x *Group) GetScopeType() uint32 {
	if x != nil {
		return x.ScopeType
	}
	return 0
...
func (x *Group) GetCohortId() string {
	if x != nil {
		return x.CohortId
	}
	return ""
...
// A list of characters belonging to a group, along with their role.
type GroupCharacterList struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Character-role pairs for a group.
	GroupCharacters []*GroupCharacterList_GroupCharacter `protobuf:"bytes,1,rep,name=group_characters,json=groupCharacters,proto3" json:"group_characters,omitempty"`
	// Cursor for the next page of results, if any.
	Cursor        string `protobuf:"bytes,2,opt,name=cursor,proto3" json:"cursor,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GroupCharacterList) Reset() {
	*x = GroupCharacterList{}
	mi := &file_api_proto_msgTypes[48]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GroupCharacterList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GroupCharacterList) ProtoMessage() {}

func (x *GroupCharacterList) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[48]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GroupCharacterList.ProtoReflect.Descriptor instead.
func (*GroupCharacterList) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{48}
}

func (x *GroupCharacterList) GetGroupCharacters() []*GroupCharacterList_GroupCharacter {
	if x != nil {
		return x.GroupCharacters
	}
	return nil
}

func (x *GroupCharacterList) GetCursor() string {
	if x != nil {
		return x.Cursor
	}
	return ""
...
// Kick a set of characters from a group.
type KickGroupCharactersRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The group ID to kick from.
	GroupId string `protobuf:"bytes,1,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`
	// The characters to kick.
	CharacterIds  []string `protobuf:"bytes,2,rep,name=character_ids,json=characterIds,proto3" json:"character_ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *KickGroupCharactersRequest) Reset() {
	*x = KickGroupCharactersRequest{}
	mi := &file_api_proto_msgTypes[51]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *KickGroupCharactersRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KickGroupCharactersRequest) ProtoMessage() {}

func (x *KickGroupCharactersRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[51]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KickGroupCharactersRequest.ProtoReflect.Descriptor instead.
func (*KickGroupCharactersRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{51}
}

func (x *KickGroupCharactersRequest) GetGroupId() string {
	if x != nil {
		return x.GroupId
	}
	return ""
...
func (x *KickGroupCharactersRequest) GetCharacterIds() []string {
	if x != nil {
		return x.CharacterIds
	}
	return nil
...
type Leaderboard struct {
	...
	// Scope type: 0=global (default), 1=realm, 2=cohort, 3=event.
	ScopeType uint32 `protobuf:"varint,9,opt,name=scope_type,json=scopeType,proto3" json:"scope_type,omitempty"`
	// The realm ID if this leaderboard is realm-scoped.
	RealmId string `protobuf:"bytes,10,opt,name=realm_id,json=realmId,proto3" json:"realm_id,omitempty"`
	// The cohort ID if this leaderboard is cohort-scoped.
	CohortId      string `protobuf:"bytes,11,opt,name=cohort_id,json=cohortId,proto3" json:"cohort_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Leaderboard) GetScopeType() uint32 {
	if x != nil {
		return x.ScopeType
	}
	return 0
...
func (x *Leaderboard) GetRealmId() string {
	if x != nil {
		return x.RealmId
	}
	return ""
...
func (x *Leaderboard) GetCohortId() string {
	if x != nil {
		return x.CohortId
	}
	return ""
...
type LeaderboardRecord struct {
	...
	// The realm from which this record was submitted. Enables filtering records within a leaderboard by realm.
	RealmId string `protobuf:"bytes,13,opt,name=realm_id,json=realmId,proto3" json:"realm_id,omitempty"`
	// The character that submitted this record. Enables per-character analytics when a user has multiple characters.
	CharacterId   string `protobuf:"bytes,14,opt,name=character_id,json=characterId,proto3" json:"character_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LeaderboardRecord) GetRealmId() string {
	if x != nil {
		return x.RealmId
	}
	return ""
...
func (x *LeaderboardRecord) GetCharacterId() string {
	if x != nil {
		return x.CharacterId
	}
	return ""
...
type ListChannelMessagesRequest struct {
	...
	// Optional realm ID to filter messages by scope.
	RealmId string `protobuf:"bytes,5,opt,name=realm_id,json=realmId,proto3" json:"realm_id,omitempty"`
	// Include global messages when filtering by realm. Default false.
	IncludeGlobal bool `protobuf:"varint,6,opt,name=include_global,json=includeGlobal,proto3" json:"include_global,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListChannelMessagesRequest) GetRealmId() string {
	if x != nil {
		return x.RealmId
	}
	return ""
...
func (x *ListChannelMessagesRequest) GetIncludeGlobal() bool {
	if x != nil {
...
type ListGroupsRequest struct {
	...
	// Scope type filter: 0=global only, 1=realm only, unset=both.
	ScopeType *wrapperspb.UInt32Value `protobuf:"bytes,7,opt,name=scope_type,json=scopeType,proto3" json:"scope_type,omitempty"`
	// Include global groups when listing realm groups. Default true.
	IncludeGlobal *wrapperspb.BoolValue `protobuf:"bytes,8,opt,name=include_global,json=includeGlobal,proto3" json:"include_global,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListGroupsRequest) GetScopeType() *wrapperspb.UInt32Value {
	if x != nil {
		return x.ScopeType
	}
	return nil
...
func (x *ListGroupsRequest) GetIncludeGlobal() *wrapperspb.BoolValue {
	if x != nil {
		return x.IncludeGlobal
	}
	return nil
...
type ListSubscriptionsRequest struct {
	...
	Cursor string `protobuf:"bytes,2,opt,name=cursor,proto3" json:"cursor,omitempty"`
	// Optional realm ID filter. Only returns subscriptions for this realm.
	RealmId string `protobuf:"bytes,3,opt,name=realm_id,json=realmId,proto3" json:"realm_id,omitempty"`
	// Optional character ID filter. Only returns subscriptions for this character.
	CharacterId string `protobuf:"bytes,4,opt,name=character_id,json=characterId,proto3" json:"character_id,omitempty"`
	// Include account-scoped subscriptions when filtering by realm/character. Default true.
	IncludeAccountScoped *wrapperspb.BoolValue `protobuf:"bytes,5,opt,name=include_account_scoped,json=includeAccountScoped,proto3" json:"include_account_scoped,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *ListSubscriptionsRequest) GetRealmId() string {
	if x != nil {
		return x.RealmId
	}
	return ""
...
func (x *ListSubscriptionsRequest) GetCharacterId() string {
	if x != nil {
		return x.CharacterId
	}
	return ""
...
func (x *ListSubscriptionsRequest) GetIncludeAccountScoped() *wrapperspb.BoolValue {
	if x != nil {
		return x.IncludeAccountScoped
	}
	return nil
}
...
type ListTournamentsRequest struct {
	...
	// Scope type filter: 0=global only, 1=realm only, unset=both.
	ScopeType *wrapperspb.UInt32Value `protobuf:"bytes,9,opt,name=scope_type,json=scopeType,proto3" json:"scope_type,omitempty"`
	// Include global tournaments when listing realm tournaments. Default true.
	IncludeGlobal *wrapperspb.BoolValue `protobuf:"bytes,10,opt,name=include_global,json=includeGlobal,proto3" json:"include_global,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListTournamentsRequest) GetScopeType() *wrapperspb.UInt32Value {
	if x != nil {
		return x.ScopeType
	}
	return nil
...
func (x *ListTournamentsRequest) GetIncludeGlobal() *wrapperspb.BoolValue {
	if x != nil {
		return x.IncludeGlobal
	}
	return nil
...
// List the groups a character is part of, and their relationship to each.
type ListCharacterGroupsRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// ID of the character.
	CharacterId string `protobuf:"bytes,1,opt,name=character_id,json=characterId,proto3" json:"character_id,omitempty"`
	// Max number of records to return. Between 1 and 100.
	Limit *wrapperspb.Int32Value `protobuf:"bytes,2,opt,name=limit,proto3" json:"limit,omitempty"`
	// The character group state to list.
	State *wrapperspb.Int32Value `protobuf:"bytes,3,opt,name=state,proto3" json:"state,omitempty"`
	// An optional next page cursor.
	Cursor        string `protobuf:"bytes,4,opt,name=cursor,proto3" json:"cursor,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *ListCharacterGroupsRequest) Reset() {
	*x = ListCharacterGroupsRequest{}
	mi := &file_api_proto_msgTypes[73]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListCharacterGroupsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListCharacterGroupsRequest) ProtoMessage() {}

func (x *ListCharacterGroupsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[73]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListCharacterGroupsRequest.ProtoReflect.Descriptor instead.
func (*ListCharacterGroupsRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{73}
}

func (x *ListCharacterGroupsRequest) GetCharacterId() string {
	if x != nil {
		return x.CharacterId
	}
	return ""
...
func (x *ListCharacterGroupsRequest) GetLimit() *wrapperspb.Int32Value {
	if x != nil {
		return x.Limit
	}
	return nil
...
func (x *ListCharacterGroupsRequest) GetState() *wrapperspb.Int32Value {
	if x != nil {
		return x.State
	}
	return nil
...
func (x *ListCharacterGroupsRequest) GetCursor() string {
	if x != nil {
		return x.Cursor
	}
	return ""
...
type Match struct {
	...
	// The external URL of the node hosting this match, if available.
...
func (x *Match) GetNodeUrl() string {
	if x != nil {
		return x.NodeUrl
	}
	return ""
...
// Promote a set of characters in a group to the next role up.
type PromoteGroupCharactersRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The group ID to promote in.
	GroupId string `protobuf:"bytes,1,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`
	// The characters to promote.
	CharacterIds  []string `protobuf:"bytes,2,rep,name=character_ids,json=characterIds,proto3" json:"character_ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PromoteGroupCharactersRequest) Reset() {
	*x = PromoteGroupCharactersRequest{}
	mi := &file_api_proto_msgTypes[80]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PromoteGroupCharactersRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PromoteGroupCharactersRequest) ProtoMessage() {}

func (x *PromoteGroupCharactersRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[80]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PromoteGroupCharactersRequest.ProtoReflect.Descriptor instead.
func (*PromoteGroupCharactersRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{80}
}

func (x *PromoteGroupCharactersRequest) GetGroupId() string {
	if x != nil {
		return x.GroupId
	}
	return ""
...
func (x *PromoteGroupCharactersRequest) GetCharacterIds() []string {
	if x != nil {
		return x.CharacterIds
	}
	return nil
...
// Demote a set of characters in a group to the next role down.
type DemoteGroupCharactersRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The group ID to demote in.
	GroupId string `protobuf:"bytes,1,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`
	// The characters to demote.
	CharacterIds  []string `protobuf:"bytes,2,rep,name=character_ids,json=characterIds,proto3" json:"character_ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DemoteGroupCharactersRequest) Reset() {
	*x = DemoteGroupCharactersRequest{}
	mi := &file_api_proto_msgTypes[81]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DemoteGroupCharactersRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DemoteGroupCharactersRequest) ProtoMessage() {}

func (x *DemoteGroupCharactersRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[81]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DemoteGroupCharactersRequest.ProtoReflect.Descriptor instead.
func (*DemoteGroupCharactersRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{81}
}

func (x *DemoteGroupCharactersRequest) GetGroupId() string {
	if x != nil {
		return x.GroupId
	}
	return ""
...
func (x *DemoteGroupCharactersRequest) GetCharacterIds() []string {
	if x != nil {
		return x.CharacterIds
	}
	return nil
...
func (x *ReadStorageObjectId) GetCharacterId() string {
	if x != nil {
		return x.CharacterId
	}
	return ""
...
func (x *StorageObject) GetCharacterId() string {
	if x != nil {
		return x.CharacterId
	}
	return ""
...
func (x *StorageObject) GetRealmId() string {
	if x != nil {
		return x.RealmId
	}
	return ""
...
func (x *StorageObjectAck) GetCharacterId() string {
	if x != nil {
		return x.CharacterId
	}
	return ""
...
func (x *StorageObjectAck) GetRealmId() string {
	if x != nil {
		return x.RealmId
	}
	return ""
...
type Tournament struct {
	...
	// Scope type: 0=global (default), 1=realm, 2=cohort, 3=event.
	ScopeType uint32 `protobuf:"varint,22,opt,name=scope_type,json=scopeType,proto3" json:"scope_type,omitempty"`
	// The realm ID if this tournament is realm-scoped.
	RealmId string `protobuf:"bytes,23,opt,name=realm_id,json=realmId,proto3" json:"realm_id,omitempty"`
	// The cohort ID if this tournament is cohort-scoped.
	CohortId      string `protobuf:"bytes,24,opt,name=cohort_id,json=cohortId,proto3" json:"cohort_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Tournament) GetScopeType() uint32 {
	if x != nil {
		return x.ScopeType
	}
	return 0
...
func (x *Tournament) GetRealmId() string {
	if x != nil {
		return x.RealmId
	}
	return ""
...
func (x *Tournament) GetCohortId() string {
	if x != nil {
		return x.CohortId
	}
	return ""
...
// A list of groups belonging to a character, along with the character's role in each group.
type CharacterGroupList struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Group-role pairs for a character.
	CharacterGroups []*CharacterGroupList_CharacterGroup `protobuf:"bytes,1,rep,name=character_groups,json=characterGroups,proto3" json:"character_groups,omitempty"`
	// Cursor for the next page of results, if any.
	Cursor        string `protobuf:"bytes,2,opt,name=cursor,proto3" json:"cursor,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *CharacterGroupList) Reset() {
	*x = CharacterGroupList{}
	mi := &file_api_proto_msgTypes[97]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CharacterGroupList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CharacterGroupList) ProtoMessage() {}

func (x *CharacterGroupList) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[97]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CharacterGroupList.ProtoReflect.Descriptor instead.
func (*CharacterGroupList) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{97}
}

func (x *CharacterGroupList) GetCharacterGroups() []*CharacterGroupList_CharacterGroup {
	if x != nil {
		return x.CharacterGroups
	}
	return nil
}

func (x *CharacterGroupList) GetCursor() string {
	if x != nil {
		return x.Cursor
	}
	return ""
...
type ValidatedPurchase struct {
	...
	// The scope type of this purchase: 0=account (cross-realm), 1=character.
	ScopeType uint32 `protobuf:"varint,12,opt,name=scope_type,json=scopeType,proto3" json:"scope_type,omitempty"`
	// The realm ID (set for character-scoped purchases via character's realm).
	RealmId string `protobuf:"bytes,13,opt,name=realm_id,json=realmId,proto3" json:"realm_id,omitempty"`
	// The character ID if this purchase is character-scoped.
	CharacterId   string `protobuf:"bytes,14,opt,name=character_id,json=characterId,proto3" json:"character_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ValidatedPurchase) GetScopeType() uint32 {
	if x != nil {
		return x.ScopeType
	}
	return 0
...
func (x *ValidatedPurchase) GetRealmId() string {
	if x != nil {
		return x.RealmId
	}
	return ""
...
func (x *ValidatedPurchase) GetCharacterId() string {
	if x != nil {
		return x.CharacterId
	}
	return ""
...
type ValidatedSubscription struct {
	...
	// Scope type for this subscription: 0=account (cross-realm), 1=character.
	ScopeType uint32 `protobuf:"varint,14,opt,name=scope_type,json=scopeType,proto3" json:"scope_type,omitempty"`
	// Realm ID (set for character-scoped subscriptions via character's realm).
	RealmId string `protobuf:"bytes,15,opt,name=realm_id,json=realmId,proto3" json:"realm_id,omitempty"`
	// Character ID if character-scoped.
...
func (x *ValidatedSubscription) GetScopeType() uint32 {
	if x != nil {
		return x.ScopeType
	}
	return 0
...
func (x *ValidatedSubscription) GetRealmId() string {
	if x != nil {
		return x.RealmId
	}
	return ""
...
func (x *ValidatedSubscription) GetCharacterId() string {
	if x != nil {
		return x.CharacterId
	}
	return ""
...
// Transfer policies for realm-to-realm character movement.
// Application-specific details should go in the custom field.
type TransferPolicy struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Whether transfers into this realm are allowed.
	EnabledIn bool `protobuf:"varint,1,opt,name=enabled_in,json=enabledIn,proto3" json:"enabled_in,omitempty"`
	// Whether transfers out of this realm are allowed.
	EnabledOut bool `protobuf:"varint,2,opt,name=enabled_out,json=enabledOut,proto3" json:"enabled_out,omitempty"`
	// Cooldown period in hours between transfers (0 = no cooldown).
	CooldownHours int32 `protobuf:"varint,3,opt,name=cooldown_hours,json=cooldownHours,proto3" json:"cooldown_hours,omitempty"`
	// Tags that block transfers FROM realms with these tags.
	BlockedSourceTags []string `protobuf:"bytes,4,rep,name=blocked_source_tags,json=blockedSourceTags,proto3" json:"blocked_source_tags,omitempty"`
	// Tags that block transfers TO realms with these tags.
	BlockedTargetTags []string `protobuf:"bytes,5,rep,name=blocked_target_tags,json=blockedTargetTags,proto3" json:"blocked_target_tags,omitempty"`
	// Source realm must have ALL these tags for transfer.
	RequireSourceTags []string `protobuf:"bytes,6,rep,name=require_source_tags,json=requireSourceTags,proto3" json:"require_source_tags,omitempty"`
	// Target realm must have ALL these tags for transfer.
	RequireTargetTags []string `protobuf:"bytes,7,rep,name=require_target_tags,json=requireTargetTags,proto3" json:"require_target_tags,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *TransferPolicy) GetEnabledIn() bool {
	if x != nil {
		return x.EnabledIn
	}
	return false
...
func (x *TransferPolicy) GetEnabledOut() bool {
	if x != nil {
		return x.EnabledOut
	}
	return false
...
func (x *TransferPolicy) GetCooldownHours() int32 {
	if x != nil {
...
func (x *TransferPolicy) GetBlockedSourceTags() []string {
	if x != nil {
		return x.BlockedSourceTags
	}
	return nil
}

func (x *TransferPolicy) GetBlockedTargetTags() []string {
	if x != nil {
		return x.BlockedTargetTags
	}
	return nil
}

func (x *TransferPolicy) GetRequireSourceTags() []string {
	if x != nil {
		return x.RequireSourceTags
	}
	return nil
}

func (x *TransferPolicy) GetRequireTargetTags() []string {
	if x != nil {
		return x.RequireTargetTags
	}
	return nil
}

// Queue policies for realm capacity management.
type QueuePolicy struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Whether queueing is enabled when realm is at capacity.
	Enabled bool `protobuf:"varint,1,opt,name=enabled,proto3" json:"enabled,omitempty"`
	// Maximum ratio of current_players to max_players before queue activates (e.g., 1.0 = 100%).
	MaxCapacityRatio float64 `protobuf:"fixed64,2,opt,name=max_capacity_ratio,json=maxCapacityRatio,proto3" json:"max_capacity_ratio,omitempty"`
	// Whether VIP priority is enabled for queue.
	PriorityEnabled bool `protobuf:"varint,3,opt,name=priority_enabled,json=priorityEnabled,proto3" json:"priority_enabled,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *QueuePolicy) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *QueuePolicy) GetMaxCapacityRatio() float64 {
	if x != nil {
		return x.MaxCapacityRatio
	}
	return 0
}

func (x *QueuePolicy) GetPriorityEnabled() bool {
	if x != nil {
		return x.PriorityEnabled
	}
	return false
}

// Naming policies for character names in this realm.
type NamingPolicy struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Policy type: "standard", "strict", "relaxed", or custom application-defined.
	...
	AllowedPattern string `protobuf:"bytes,4,opt,name=allowed_pattern,json=allowedPattern,proto3" json:"allowed_pattern,omitempty"`
	// Reserved names that cannot be used.
	ReservedNames []string `protobuf:"bytes,5,rep,name=reserved_names,json=reservedNames,proto3" json:"reserved_names,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *NamingPolicy) Reset() {
	*x = NamingPolicy{}
...
func (x *NamingPolicy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NamingPolicy) ProtoMessage() {}

func (x *NamingPolicy) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[120]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NamingPolicy.ProtoReflect.Descriptor instead.
func (*NamingPolicy) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{120}
}

func (x *NamingPolicy) GetPolicy() string {
	if x != nil {
		return x.Policy
	}
	return ""
...
func (x *NamingPolicy) GetMinLength() int32 {
	if x != nil {
		return x.MinLength
	}
	return 0
...
func (x *NamingPolicy) GetMaxLength() int32 {
	if x != nil {
		return x.MaxLength
	}
	return 0
...
func (x *NamingPolicy) GetAllowedPattern() string {
	if x != nil {
...
func (x *NamingPolicy) GetReservedNames() []string {
	if x != nil {
...
// Access policies for realm entry requirements.
type AccessPolicy struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Whether the realm accepts new players (character creation). Defaults to true if not set.
	AllowNewPlayers *wrapperspb.BoolValue `protobuf:"bytes,1,opt,name=allow_new_players,json=allowNewPlayers,proto3" json:"allow_new_players,omitempty"`
	// Whether the realm requires an invite to join.
	RequiresInvite bool `protobuf:"varint,2,opt,name=requires_invite,json=requiresInvite,proto3" json:"requires_invite,omitempty"`
	// User must have ALL these tags to access.
	AllowedUserTags []string `protobuf:"bytes,4,rep,name=allowed_user_tags,json=allowedUserTags,proto3" json:"allowed_user_tags,omitempty"`
	// Users with ANY of these tags are blocked.
	BlockedUserTags []string `protobuf:"bytes,5,rep,name=blocked_user_tags,json=blockedUserTags,proto3" json:"blocked_user_tags,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *AccessPolicy) GetAllowNewPlayers() *wrapperspb.BoolValue {
	if x != nil {
		return x.AllowNewPlayers
	}
	return nil
}

func (x *AccessPolicy) GetRequiresInvite() bool {
	if x != nil {
...
func (x *AccessPolicy) GetAllowedUserTags() []string {
	if x != nil {
		return x.AllowedUserTags
	}
	return nil
}

func (x *AccessPolicy) GetBlockedUserTags() []string {
	if x != nil {
		return x.BlockedUserTags
	}
	return nil
}

// Combined realm policies with structured core policies and extensible custom policies.
// Used both as the effective (merged) policy on a realm and as override/default policy for inheritance.
type RealmPolicies struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Transfer restrictions and requirements.
	Transfer *TransferPolicy `protobuf:"bytes,1,opt,name=transfer,proto3" json:"transfer,omitempty"`
	// Queue management settings.
	Queue *QueuePolicy `protobuf:"bytes,2,opt,name=queue,proto3" json:"queue,omitempty"`
	// Character naming rules.
	Naming *NamingPolicy `protobuf:"bytes,3,opt,name=naming,proto3" json:"naming,omitempty"`
	// Realm access requirements.
	Access *AccessPolicy `protobuf:"bytes,4,opt,name=access,proto3" json:"access,omitempty"`
	// Custom application-specific policies as a JSON string (for extensibility).
	Custom string `protobuf:"bytes,5,opt,name=custom,proto3" json:"custom,omitempty"`
	// Feature flags enabled for this realm (e.g., "pvp", "guilds", "auction_house").
	AllowedFeatures []string `protobuf:"bytes,6,rep,name=allowed_features,json=allowedFeatures,proto3" json:"allowed_features,omitempty"`
	// Maximum currency a player can hold in this realm (0 = no cap).
	CurrencyCap   int64 `protobuf:"varint,7,opt,name=currency_cap,json=currencyCap,proto3" json:"currency_cap,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *RealmPolicies) Reset() {
	*x = RealmPolicies{}
...
func (x *RealmPolicies) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RealmPolicies) ProtoMessage() {}

func (x *RealmPolicies) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[122]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RealmPolicies.ProtoReflect.Descriptor instead.
func (*RealmPolicies) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{122}
}

func (x *RealmPolicies) GetTransfer() *TransferPolicy {
	if x != nil {
		return x.Transfer
	}
	return nil
...
func (x *RealmPolicies) GetQueue() *QueuePolicy {
	if x != nil {
		return x.Queue
	}
	return nil
...
func (x *RealmPolicies) GetNaming() *NamingPolicy {
	if x != nil {
		return x.Naming
	}
	return nil
...
func (x *RealmPolicies) GetAccess() *AccessPolicy {
	if x != nil {
		return x.Access
	}
	return nil
...
func (x *RealmPolicies) GetCustom() string {
	if x != nil {
		return x.Custom
	}
	return ""
...
func (x *RealmPolicies) GetAllowedFeatures() []string {
	if x != nil {
...
func (x *RealmPolicies) GetCurrencyCap() int64 {
	if x != nil {
		return x.CurrencyCap
	}
	return 0
}

// A realm (game world or environment instance).
type Realm struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The unique identifier of the realm.
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// The human-readable name of the realm.
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	// The URL-friendly slug of the realm. Auto-generated from name if not provided.
	Slug string `protobuf:"bytes,3,opt,name=slug,proto3" json:"slug,omitempty"`
	// A description of the realm.
	Description string `protobuf:"bytes,4,opt,name=description,proto3" json:"description,omitempty"`
	// Additional realm configuration as a JSON object.
	Config string `protobuf:"bytes,5,opt,name=config,proto3" json:"config,omitempty"`
	// The status of the realm (lifecycle: ACTIVE → COMING_SOON → MAINTENANCE → LOCKED → RETIRING → RETIRED).
	Status RealmStatus `protobuf:"varint,6,opt,name=status,proto3,enum=nakama.api.RealmStatus" json:"status,omitempty"`
	// The maximum number of players allowed in the realm.
	MaxPlayers int32 `protobuf:"varint,7,opt,name=max_players,json=maxPlayers,proto3" json:"max_players,omitempty"`
	// The current number of players in the realm (managed by Nakama, not settable via admin API).
	...
	// The region of the realm (e.g., "us-east", "eu-west").
	Region string `protobuf:"bytes,9,opt,name=region,proto3" json:"region,omitempty"`
	// The version of the realm.
	Version string `protobuf:"bytes,10,opt,name=version,proto3" json:"version,omitempty"`
	// The UNIX time (for gRPC clients) or ISO string (for REST clients) when the realm was created.
	CreateTime *timestamppb.Timestamp `protobuf:"bytes,11,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`
	// The UNIX time (for gRPC clients) or ISO string (for REST clients) when the realm was last updated.
	UpdateTime *timestamppb.Timestamp `protobuf:"bytes,12,opt,name=update_time,json=updateTime,proto3" json:"update_time,omitempty"`
	// Classification tags for the realm (e.g., "seasonal", "region:us-east", "type:pvp"). Max 10 tags, 50 chars each.
	Tags []string `protobuf:"bytes,13,rep,name=tags,proto3" json:"tags,omitempty"`
	// Effective policy configuration: the merged result of group default policy + realm policy overrides.
	Policies *RealmPolicies `protobuf:"bytes,14,opt,name=policies,proto3" json:"policies,omitempty"`
...
func (x *Realm) GetStatus() RealmStatus {
	...
	return RealmStatus_REALM_STATUS_ACTIVE
}

func (x *Realm) GetMaxPlayers() int32 {
	if x != nil {
		return x.MaxPlayers
	}
	return 0
...
func (x *Realm) GetCurrentPlayers() int32 {
	if x != nil {
...
func (x *Realm) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *Realm) GetPolicies() *RealmPolicies {
	if x != nil {
		return x.Policies
	}
	return nil
...
func (x *Realm) GetMetadata() string {
	if x != nil {
		return x.Metadata
	}
	return ""
...
func (x *Realm) GetRealmGroupId() string {
	if x != nil {
...
type Character struct {
	...
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// The user ID who owns this character.
	UserId string `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	// The realm ID where this character exists.
	RealmId string `protobuf:"bytes,3,opt,name=realm_id,json=realmId,proto3" json:"realm_id,omitempty"`
	...
	CreateTime *timestamppb.Timestamp `protobuf:"bytes,8,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`
	// The UNIX time (for gRPC clients) or ISO string (for REST clients) when the character was last updated.
	UpdateTime *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=update_time,json=updateTime,proto3" json:"update_time,omitempty"`
	...
	// The avatar identifier for this character.
...
func (x *Character) GetRealmId() string {
	if x != nil {
		return x.RealmId
	}
	return ""
...
func (x *Character) GetStatus() CharacterStatus {
	...
	return CharacterStatus_CHARACTER_STATUS_ACTIVE
}
...
func (x *Character) GetLastLoginAt() *timestamppb.Timestamp {
	if x != nil {
...
func (x *Character) GetRealm() *Realm {
	if x != nil {
		return x.Realm
	}
	return nil
...
type ListRealmsRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Optional filter by realm status.
...
func (x *ListRealmsRequest) GetStatus() *wrapperspb.Int32Value {
	if x != nil {
		return x.Status
	}
	return nil
...
func (x *RealmList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RealmList) ProtoMessage() {}

func (x *RealmList) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[126]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RealmList.ProtoReflect.Descriptor instead.
func (*RealmList) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{126}
}

func (x *RealmList) GetRealms() []*Realm {
	if x != nil {
		return x.Realms
	}
	return nil
...
// Request to get a realm by ID or slug.
type GetRealmRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The ID or slug of the realm.
	Id            string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
// Request to list characters for the current user.
...
type CreateCharacterRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The realm ID or slug where the character will be created.
...
func (x *CreateCharacterRequest) GetRealmId() string {
	if x != nil {
		return x.RealmId
	}
	return ""
...
func (x *UpdateCharacterRequest) GetAvatar() *wrapperspb.StringValue {
	if x != nil {
		return x.Avatar
	}
	return nil
...
type SelectCharacterRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The ID of the character to select.
	CharacterId   string `protobuf:"bytes,1,opt,name=character_id,json=characterId,proto3" json:"character_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
// Response from selecting a character.
type SelectCharacterResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The new session token with realm context.
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
	// The new refresh token with realm context.
	RefreshToken string `protobuf:"bytes,2,opt,name=refresh_token,json=refreshToken,proto3" json:"refresh_token,omitempty"`
...
func (x *SelectCharacterResponse) GetRefreshToken() string {
	if x != nil {
		return x.RefreshToken
	}
	return ""
...
// A character's wallet containing realm-specific currencies.
type CharacterWallet struct {
	...
	// The realm ID where this character exists.
	RealmId string `protobuf:"bytes,3,opt,name=realm_id,json=realmId,proto3" json:"realm_id,omitempty"`
	// The wallet data as JSON object.
	Wallet string `protobuf:"bytes,4,opt,name=wallet,proto3" json:"wallet,omitempty"`
	// The UNIX time (for gRPC clients) or ISO string (for REST clients) when the wallet was created.
	CreateTime *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`
	// The UNIX time (for gRPC clients) or ISO string (for REST clients) when the wallet was last updated.
...
func (x *CharacterWallet) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *CharacterWallet) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *CharacterWallet) GetRealmId() string {
	if x != nil {
		return x.RealmId
	}
	return ""
...
func (x *CharacterWallet) GetWallet() string {
	if x != nil {
		return x.Wallet
	}
	return ""
...
func (x *CharacterWallet) GetCreateTime() *timestamppb.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *CharacterWallet) GetUpdateTime() *timestamppb.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
// Request to get a character's wallet.
type GetCharacterWalletRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Optional character ID. If not provided, uses active character from session.
	CharacterId   string `protobuf:"bytes,1,opt,name=character_id,json=characterId,proto3" json:"character_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetCharacterWalletRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Request to update a character's wallet.
type UpdateCharacterWalletRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Optional character ID. If not provided, uses active character from session.
	CharacterId string `protobuf:"bytes,1,opt,name=character_id,json=characterId,proto3" json:"character_id,omitempty"`
	// The changeset to apply to the wallet. Positive values add, negative values subtract.
	Changeset map[string]int64 `protobuf:"bytes,2,rep,name=changeset,proto3" json:"changeset,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
...
func (x *UpdateCharacterWalletRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *UpdateCharacterWalletRequest) GetChangeset() map[string]int64 {
	if x != nil {
		return x.Changeset
	}
	return nil
...
func (x *UpdateCharacterWalletRequest) GetMetadata() map[string]string {
	if x != nil {
		return x.Metadata
	}
	return nil
...
// Response from updating a character's wallet.
type UpdateCharacterWalletResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The updated wallet.
	Wallet *CharacterWallet `protobuf:"bytes,1,opt,name=wallet,proto3" json:"wallet,omitempty"`
	// The previous wallet values before the update.
	Previous map[string]int64 `protobuf:"bytes,2,rep,name=previous,proto3" json:"previous,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	// The updated wallet values after the update.
	Updated       map[string]int64 `protobuf:"bytes,3,rep,name=updated,proto3" json:"updated,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateCharacterWalletResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *UpdateCharacterWalletResponse) GetPrevious() map[string]int64 {
	if x != nil {
		return x.Previous
	}
	return nil
...
func (x *UpdateCharacterWalletResponse) GetUpdated() map[string]int64 {
	if x != nil {
		return x.Updated
	}
	return nil
...
// A ledger entry for a character wallet transaction.
type CharacterWalletLedger struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The ledger entry ID.
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// The character ID.
	...
	// The changeset applied to the wallet.
	Changeset map[string]int64 `protobuf:"bytes,5,rep,name=changeset,proto3" json:"changeset,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	// The metadata associated with this change.
	Metadata map[string]string `protobuf:"bytes,6,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// The UNIX time (for gRPC clients) or ISO string (for REST clients) when the entry was created.
	CreateTime *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`
	// The UNIX time (for gRPC clients) or ISO string (for REST clients) when the entry was last updated.
	UpdateTime    *timestamppb.Timestamp `protobuf:"bytes,8,opt,name=update_time,json=updateTime,proto3" json:"update_time,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CharacterWalletLedger) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *CharacterWalletLedger) GetCharacterId() string {
	if x != nil {
		return x.CharacterId
	}
	return ""
...
func (x *CharacterWalletLedger) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *CharacterWalletLedger) GetRealmId() string {
	if x != nil {
		return x.RealmId
	}
	return ""
...
func (x *CharacterWalletLedger) GetChangeset() map[string]int64 {
	if x != nil {
		return x.Changeset
	}
	return nil
...
func (x *CharacterWalletLedger) GetMetadata() map[string]string {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *CharacterWalletLedger) GetCreateTime() *timestamppb.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *CharacterWalletLedger) GetUpdateTime() *timestamppb.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
// Request to list character wallet ledger entries.
type ListCharacterWalletLedgerRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Optional character ID. If not provided, uses active character from session.
	CharacterId string `protobuf:"bytes,1,opt,name=character_id,json=characterId,proto3" json:"character_id,omitempty"`
	// Max number of results per page. Between 1 and 100.
	Limit *wrapperspb.Int32Value `protobuf:"bytes,2,opt,name=limit,proto3" json:"limit,omitempty"`
	// Cursor to retrieve a page of records from.
	Cursor        string `protobuf:"bytes,3,opt,name=cursor,proto3" json:"cursor,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *ListCharacterWalletLedgerRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ListCharacterWalletLedgerRequest) GetLimit() *wrapperspb.Int32Value {
	if x != nil {
		return x.Limit
	}
	return nil
...
func (x *ListCharacterWalletLedgerRequest) GetCursor() string {
	if x != nil {
		return x.Cursor
	}
	return ""
...
// A list of character wallet ledger entries.
type CharacterWalletLedgerList struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The list of ledger entries.
	Items []*CharacterWalletLedger `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty"`
	// Cursor for the next page of results, if any.
	Cursor string `protobuf:"bytes,2,opt,name=cursor,proto3" json:"cursor,omitempty"`
...
func (x *CharacterWalletLedgerList) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *CharacterWalletLedgerList) GetCursor() string {
	if x != nil {
		return x.Cursor
	}
	return ""
...
func (x *CharacterWalletLedgerList) GetPrevCursor() string {
	if x != nil {
		return x.PrevCursor
	}
	return ""
...
// Request to list purchases with optional scope filters.
type ListPurchasesRequest struct {
	...
	// Cursor to retrieve a page of records from.
	Cursor string `protobuf:"bytes,2,opt,name=cursor,proto3" json:"cursor,omitempty"`
	// Optional realm ID filter. Only returns purchases for this realm.
	RealmId string `protobuf:"bytes,3,opt,name=realm_id,json=realmId,proto3" json:"realm_id,omitempty"`
	// Optional character ID filter. Only returns purchases for this character.
	CharacterId string `protobuf:"bytes,4,opt,name=character_id,json=characterId,proto3" json:"character_id,omitempty"`
	// Include account-scoped purchases (scope_type=0) when filtering by realm/character. Default true.
	IncludeAccountScoped *wrapperspb.BoolValue `protobuf:"bytes,5,opt,name=include_account_scoped,json=includeAccountScoped,proto3" json:"include_account_scoped,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *ListPurchasesRequest) GetRealmId() string {
	if x != nil {
		return x.RealmId
	}
	return ""
...
func (x *ListPurchasesRequest) GetCharacterId() string {
	if x != nil {
		return x.CharacterId
	}
	return ""
...
func (x *ListPurchasesRequest) GetIncludeAccountScoped() *wrapperspb.BoolValue {
	if x != nil {
		return x.IncludeAccountScoped
	}
	return nil
...
// A record of a character transfer between realms.
type CharacterTransfer struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The unique identifier of the transfer.
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// The character ID being transferred.
	CharacterId string `protobuf:"bytes,2,opt,name=character_id,json=characterId,proto3" json:"character_id,omitempty"`
	// The user ID who owns the character.
	UserId string `protobuf:"bytes,3,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	// The source realm ID.
	SourceRealmId string `protobuf:"bytes,4,opt,name=source_realm_id,json=sourceRealmId,proto3" json:"source_realm_id,omitempty"`
	// The target realm ID.
	TargetRealmId string `protobuf:"bytes,5,opt,name=target_realm_id,json=targetRealmId,proto3" json:"target_realm_id,omitempty"`
	// The status of the transfer.
	Status CharacterTransferStatus `protobuf:"varint,6,opt,name=status,proto3,enum=nakama.api.CharacterTransferStatus" json:"status,omitempty"`
	// Who initiated the transfer.
	InitiatedBy CharacterTransferInitiator `protobuf:"varint,7,opt,name=initiated_by,json=initiatedBy,proto3,enum=nakama.api.CharacterTransferInitiator" json:"initiated_by,omitempty"`
	...
	// User-defined metadata as a JSON object. Passed to hooks for custom logic.
	Metadata string `protobuf:"bytes,10,opt,name=metadata,proto3" json:"metadata,omitempty"`
	// The UNIX time (for gRPC clients) or ISO string (for REST clients) when the transfer was created.
	CreateTime *timestamppb.Timestamp `protobuf:"bytes,11,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`
	// The UNIX time (for gRPC clients) or ISO string (for REST clients) when the transfer started processing.
	StartedAt *timestamppb.Timestamp `protobuf:"bytes,12,opt,name=started_at,json=startedAt,proto3" json:"started_at,omitempty"`
	// The UNIX time (for gRPC clients) or ISO string (for REST clients) when the transfer completed.
...
func (x *CharacterTransfer) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *CharacterTransfer) GetCharacterId() string {
	if x != nil {
		return x.CharacterId
	}
	return ""
...
func (x *CharacterTransfer) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *CharacterTransfer) GetSourceRealmId() string {
	if x != nil {
		return x.SourceRealmId
	}
	return ""
}

func (x *CharacterTransfer) GetTargetRealmId() string {
	if x != nil {
		return x.TargetRealmId
	}
	return ""
}

func (x *CharacterTransfer) GetStatus() CharacterTransferStatus {
	if x != nil {
		return x.Status
	}
	return CharacterTransferStatus_CHARACTER_TRANSFER_STATUS_PENDING
}

func (x *CharacterTransfer) GetInitiatedBy() CharacterTransferInitiator {
	if x != nil {
		return x.InitiatedBy
	}
	return CharacterTransferInitiator_CHARACTER_TRANSFER_INITIATOR_USER
}

func (x *CharacterTransfer) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
func (x *CharacterTransfer) GetErrorMessage() string {
	if x != nil {
...
func (x *CharacterTransfer) GetMetadata() string {
	if x != nil {
		return x.Metadata
	}
	return ""
...
func (x *CharacterTransfer) GetCreateTime() *timestamppb.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *CharacterTransfer) GetStartedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.StartedAt
	}
	return nil
...
func (x *CharacterTransfer) GetCompletedAt() *timestamppb.Timestamp {
	if x != nil {
...
// Request to transfer a character to another realm.
type TransferCharacterRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The ID of the character to transfer.
	CharacterId string `protobuf:"bytes,1,opt,name=character_id,json=characterId,proto3" json:"character_id,omitempty"`
	// The ID or slug of the target realm.
	TargetRealmId string `protobuf:"bytes,2,opt,name=target_realm_id,json=targetRealmId,proto3" json:"target_realm_id,omitempty"`
	// Optional user-defined metadata as a JSON object. Passed to hooks for custom logic.
	Metadata      string `protobuf:"bytes,3,opt,name=metadata,proto3" json:"metadata,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TransferCharacterRequest) GetTargetRealmId() string {
	if x != nil {
		return x.TargetRealmId
	}
	return ""
...
func (x *TransferCharacterRequest) GetMetadata() string {
	if x != nil {
		return x.Metadata
	}
	return ""
...
// Response from transferring a character.
type TransferCharacterResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The transfer record.
	Transfer *CharacterTransfer `protobuf:"bytes,1,opt,name=transfer,proto3" json:"transfer,omitempty"`
	// The updated character with new realm.
...
func (x *TransferCharacterResponse) GetCharacter() *Character {
	if x != nil {
		return x.Character
	}
	return nil
...
// Request to list character transfers.
type ListCharacterTransfersRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ListCharacterTransfersRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ListCharacterTransfersRequest) GetLimit() *wrapperspb.Int32Value {
	if x != nil {
		return x.Limit
	}
	return nil
...
func (x *ListCharacterTransfersRequest) GetCursor() string {
	if x != nil {
		return x.Cursor
	}
	return ""
...
// A list of character transfers.
type CharacterTransferList struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The list of transfers.
	Transfers []*CharacterTransfer `protobuf:"bytes,1,rep,name=transfers,proto3" json:"transfers,omitempty"`
	// Cursor for the next page of results, if any.
	Cursor        string `protobuf:"bytes,2,opt,name=cursor,proto3" json:"cursor,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *CharacterTransferList) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *CharacterTransferList) GetCursor() string {
	if x != nil {
		return x.Cursor
	}
	return ""
...
// Request to check if a character is eligible to transfer to a target realm.
type TransferEligibilityRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The ID of the character to check.
	CharacterId string `protobuf:"bytes,1,opt,name=character_id,json=characterId,proto3" json:"character_id,omitempty"`
	// The ID or slug of the target realm.
	TargetRealmId string `protobuf:"bytes,2,opt,name=target_realm_id,json=targetRealmId,proto3" json:"target_realm_id,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *TransferEligibilityRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *TransferEligibilityRequest) GetTargetRealmId() string {
	if x != nil {
		return x.TargetRealmId
	}
	return ""
...
// Response with transfer eligibility details.
type TransferEligibilityResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Whether the character is eligible to transfer.
	Eligible bool `protobuf:"varint,1,opt,name=eligible,proto3" json:"eligible,omitempty"`
	// Human-readable reasons why the transfer is blocked (if not eligible).
	Blockers []string `protobuf:"bytes,2,rep,name=blockers,proto3" json:"blockers,omitempty"`
	// When the cooldown expires (if cooldown is active). Null if no cooldown.
	CooldownExpires *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=cooldown_expires,json=cooldownExpires,proto3" json:"cooldown_expires,omitempty"`
	// Hours remaining in cooldown (0 if no cooldown active).
	CooldownHoursRemaining int32 `protobuf:"varint,4,opt,name=cooldown_hours_remaining,json=cooldownHoursRemaining,proto3" json:"cooldown_hours_remaining,omitempty"`
	// The source realm (character's current realm).
	SourceRealm *Realm `protobuf:"bytes,5,opt,name=source_realm,json=sourceRealm,proto3" json:"source_realm,omitempty"`
	// The target realm.
	TargetRealm   *Realm `protobuf:"bytes,6,opt,name=target_realm,json=targetRealm,proto3" json:"target_realm,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TransferEligibilityResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *TransferEligibilityResponse) GetBlockers() []string {
	if x != nil {
		return x.Blockers
	}
	return nil
...
func (x *TransferEligibilityResponse) GetCooldownExpires() *timestamppb.Timestamp {
	if x != nil {
		return x.CooldownExpires
	}
	return nil
}

func (x *TransferEligibilityResponse) GetCooldownHoursRemaining() int32 {
	if x != nil {
		return x.CooldownHoursRemaining
	}
	return 0
}

func (x *TransferEligibilityResponse) GetSourceRealm() *Realm {
	if x != nil {
		return x.SourceRealm
	}
	return nil
}

func (x *TransferEligibilityResponse) GetTargetRealm() *Realm {
	if x != nil {
...
// A maintenance window representing scheduled or active maintenance.
type MaintenanceWindow struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The unique identifier of the maintenance window.
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// The scope of the maintenance (realm, group, or global).
	Scope MaintenanceScope `protobuf:"varint,2,opt,name=scope,proto3,enum=nakama.api.MaintenanceScope" json:"scope,omitempty"`
	// The target ID (realm_id for realm scope, group_id for group scope, empty for global).
	TargetId string `protobuf:"bytes,3,opt,name=target_id,json=targetId,proto3" json:"target_id,omitempty"`
	// Human-readable name of the target for display.
	TargetName string `protobuf:"bytes,4,opt,name=target_name,json=targetName,proto3" json:"target_name,omitempty"`
	// Short reason for the maintenance.
	...
	// When the maintenance is scheduled to end (null = indefinite).
	...
	Status MaintenanceStatus `protobuf:"varint,11,opt,name=status,proto3,enum=nakama.api.MaintenanceStatus" json:"status,omitempty"`
	// Whether staff can access during maintenance.
	AllowStaff bool `protobuf:"varint,12,opt,name=allow_staff,json=allowStaff,proto3" json:"allow_staff,omitempty"`
	// Whether to disconnect players when maintenance starts.
	DisconnectPlayers bool `protobuf:"varint,13,opt,name=disconnect_players,json=disconnectPlayers,proto3" json:"disconnect_players,omitempty"`
	// Grace period in seconds before disconnecting players.
	DisconnectGraceSeconds int32 `protobuf:"varint,14,opt,name=disconnect_grace_seconds,json=disconnectGraceSeconds,proto3" json:"disconnect_grace_seconds,omitempty"`
	// Minutes before start to send warning notifications.
	NotifyBeforeMinutes []int32 `protobuf:"varint,15,rep,packed,name=notify_before_minutes,json=notifyBeforeMinutes,proto3" json:"notify_before_minutes,omitempty"`
	// Custom notification message to send to players.
	NotificationMessage string `protobuf:"bytes,16,opt,name=notification_message,json=notificationMessage,proto3" json:"notification_message,omitempty"`
	// User ID who created this maintenance window.
...
func (x *MaintenanceWindow) GetScope() MaintenanceScope {
	if x != nil {
		return x.Scope
	}
	return MaintenanceScope_MAINTENANCE_SCOPE_REALM
}

func (x *MaintenanceWindow) GetTargetId() string {
	if x != nil {
		return x.TargetId
	}
	return ""
...
func (x *MaintenanceWindow) GetTargetName() string {
	if x != nil {
		return x.TargetName
	}
	return ""
...
func (x *MaintenanceWindow) GetScheduledStart() *timestamppb.Timestamp {
	if x != nil {
...
func (x *MaintenanceWindow) GetScheduledEnd() *timestamppb.Timestamp {
	if x != nil {
...
func (x *MaintenanceWindow) GetActualStart() *timestamppb.Timestamp {
	if x != nil {
...
func (x *MaintenanceWindow) GetActualEnd() *timestamppb.Timestamp {
	if x != nil {
		return x.ActualEnd
	}
	return nil
...
func (x *MaintenanceWindow) GetStatus() MaintenanceStatus {
	...
	return MaintenanceStatus_MAINTENANCE_STATUS_SCHEDULED
}

func (x *MaintenanceWindow) GetAllowStaff() bool {
	if x != nil {
		return x.AllowStaff
	}
	return false
...
func (x *MaintenanceWindow) GetDisconnectPlayers() bool {
	if x != nil {
		return x.DisconnectPlayers
	}
	return false
}

func (x *MaintenanceWindow) GetDisconnectGraceSeconds() int32 {
	if x != nil {
		return x.DisconnectGraceSeconds
	}
	return 0
}

func (x *MaintenanceWindow) GetNotifyBeforeMinutes() []int32 {
	if x != nil {
...
func (x *MaintenanceWindow) GetNotificationMessage() string {
	if x != nil {
...
func (x *MaintenanceWindow) GetCreateTime() *timestamppb.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *MaintenanceWindow) GetMetadata() string {
	if x != nil {
		return x.Metadata
	}
	return ""
...
type RealmGroup struct {
	...
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// The name of the realm group.
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	// URL-friendly identifier for the group.
	Slug string `protobuf:"bytes,3,opt,name=slug,proto3" json:"slug,omitempty"`
	// Description of the realm group.
	Description string `protobuf:"bytes,4,opt,name=description,proto3" json:"description,omitempty"`
	// Type of group (e.g., "region", "version", "custom").
	GroupType string `protobuf:"bytes,5,opt,name=group_type,json=groupType,proto3" json:"group_type,omitempty"`
	// IDs of realms in this group (populated on read).
	RealmIds []string `protobuf:"bytes,6,rep,name=realm_ids,json=realmIds,proto3" json:"realm_ids,omitempty"`
	// When the group was created.
	CreateTime *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`
	// When the group was last updated.
	UpdateTime *timestamppb.Timestamp `protobuf:"bytes,8,opt,name=update_time,json=updateTime,proto3" json:"update_time,omitempty"`
	// Default policy inherited by all realms in this group. Realm-specific policy overrides take precedence.
	DefaultPolicy *RealmPolicies `protobuf:"bytes,9,opt,name=default_policy,json=defaultPolicy,proto3" json:"default_policy,omitempty"`
	// Additional metadata as a JSON object.
	Metadata      string `protobuf:"bytes,10,opt,name=metadata,proto3" json:"metadata,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *RealmGroup) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RealmGroup) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *RealmGroup) GetSlug() string {
	if x != nil {
		return x.Slug
	}
	return ""
...
func (x *RealmGroup) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
func (x *RealmGroup) GetGroupType() string {
	if x != nil {
		return x.GroupType
	}
	return ""
...
func (x *RealmGroup) GetRealmIds() []string {
	if x != nil {
		return x.RealmIds
	}
	return nil
...
func (x *RealmGroup) GetCreateTime() *timestamppb.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *RealmGroup) GetUpdateTime() *timestamppb.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
func (x *RealmGroup) GetDefaultPolicy() *RealmPolicies {
	if x != nil {
...
func (x *RealmGroup) GetMetadata() string {
	if x != nil {
		return x.Metadata
	}
	return ""
...
// A realm-specific ban for a user.
type RealmBan struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The unique identifier of the realm ban.
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// The user ID who is banned.
	UserId string `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	// The realm ID the user is banned from.
	RealmId string `protobuf:"bytes,3,opt,name=realm_id,json=realmId,proto3" json:"realm_id,omitempty"`
	...
	// Who issued the ban.
	BannedBy string `protobuf:"bytes,6,opt,name=banned_by,json=bannedBy,proto3" json:"banned_by,omitempty"`
	// When the ban expires (null = permanent ban).
	ExpiresAt *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=expires_at,json=expiresAt,proto3" json:"expires_at,omitempty"`
	// When the user was unbanned (if unbanned).
	UnbannedAt *timestamppb.Timestamp `protobuf:"bytes,8,opt,name=unbanned_at,json=unbannedAt,proto3" json:"unbanned_at,omitempty"`
	// Who unbanned the user (if unbanned).
	UnbannedBy string `protobuf:"bytes,9,opt,name=unbanned_by,json=unbannedBy,proto3" json:"unbanned_by,omitempty"`
	// Additional metadata as a JSON object.
	Metadata      string `protobuf:"bytes,10,opt,name=metadata,proto3" json:"metadata,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *RealmBan) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *RealmBan) GetRealmId() string {
	if x != nil {
		return x.RealmId
	}
	return ""
...
func (x *RealmBan) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
func (x *RealmBan) GetBannedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.BannedAt
	}
	return nil
...
func (x *RealmBan) GetBannedBy() string {
	if x != nil {
		return x.BannedBy
	}
	return ""
...
func (x *RealmBan) GetExpiresAt() *timestamppb.Timestamp {
	if x != nil {
		return x.ExpiresAt
	}
	return nil
...
func (x *RealmBan) GetUnbannedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.UnbannedAt
	}
	return nil
...
func (x *RealmBan) GetUnbannedBy() string {
	if x != nil {
		return x.UnbannedBy
	}
	return ""
...
func (x *RealmBan) GetMetadata() string {
	if x != nil {
		return x.Metadata
	}
	return ""
...
// Request to change the email address on the current user's account.
...
func (x *RequestChangeEmailRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RedeemGiftcodeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Response after successful giftcode redemption.
...
func (x *RedeemGiftcodeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RedeemGiftcodeResponse) GetCampaignName() string {
	if x != nil {
...
func (x *RedeemGiftcodeResponse) GetRedeemedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.RedeemedAt
	}
	return nil
...
// A single reward attached to a mailbox entry. Mirrors PamOps RewardAttachment.
type ApiRewardAttachment struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Type          string                 `protobuf:"bytes,1,opt,name=type,proto3" json:"type,omitempty"` // currency, item, bundle, boost, cosmetic, custom
...
func (x *ApiRewardAttachment) Reset() {
	*x = ApiRewardAttachment{}
	mi := &file_api_proto_msgTypes[156]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ApiRewardAttachment) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ApiRewardAttachment) ProtoMessage() {}

func (x *ApiRewardAttachment) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[156]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ApiRewardAttachment.ProtoReflect.Descriptor instead.
func (*ApiRewardAttachment) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{156}
}

func (x *ApiRewardAttachment) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *ApiRewardAttachment) GetItemId() string {
	if x != nil {
		return x.ItemId
	}
	return ""
...
func (x *ApiRewardAttachment) GetQuantity() int32 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
func (x *ApiRewardAttachment) GetDisplayName() string {
	if x != nil {
		return x.DisplayName
	}
	return ""
...
func (x *ApiRewardAttachment) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
func (x *ApiRewardAttachment) GetIconUrl() string {
	if x != nil {
		return x.IconUrl
	}
	return ""
...
// A single mailbox entry returned to the client.
type ApiMailboxEntry struct {
	...
	MessageType   MailboxMessageType     `protobuf:"varint,5,opt,name=message_type,json=messageType,proto3,enum=nakama.api.MailboxMessageType" json:"message_type,omitempty"`
	Status        MailboxStatus          `protobuf:"varint,6,opt,name=status,proto3,enum=nakama.api.MailboxStatus" json:"status,omitempty"`
	Rewards       []*ApiRewardAttachment `protobuf:"bytes,7,rep,name=rewards,proto3" json:"rewards,omitempty"`
...
func (x *ApiMailboxEntry) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ApiMailboxEntry) ProtoMessage() {}

func (x *ApiMailboxEntry) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[157]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ApiMailboxEntry.ProtoReflect.Descriptor instead.
func (*ApiMailboxEntry) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{157}
}

func (x *ApiMailboxEntry) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *ApiMailboxEntry) GetSubject() string {
	if x != nil {
		return x.Subject
	}
	return ""
...
func (x *ApiMailboxEntry) GetBody() string {
	if x != nil {
		return x.Body
	}
	return ""
...
func (x *ApiMailboxEntry) GetImageUrl() string {
	if x != nil {
		return x.ImageUrl
	}
	return ""
...
func (x *ApiMailboxEntry) GetMessageType() MailboxMessageType {
	if x != nil {
		return x.MessageType
	}
	return MailboxMessageType_MAILBOX_MESSAGE_TYPE_UNSPECIFIED
}

func (x *ApiMailboxEntry) GetStatus() MailboxStatus {
	if x != nil {
		return x.Status
	}
...
func (x *ApiMailboxEntry) GetRewards() []*ApiRewardAttachment {
	if x != nil {
		return x.Rewards
	}
	return nil
...
func (x *ApiMailboxEntry) GetCharacterId() string {
	if x != nil {
		return x.CharacterId
	}
	return ""
...
func (x *ApiMailboxEntry) GetRealmId() string {
	if x != nil {
		return x.RealmId
	}
	return ""
...
func (x *ApiMailboxEntry) GetDeliveredAt() *timestamppb.Timestamp {
	if x != nil {
...
func (x *ApiMailboxEntry) GetReadAt() *timestamppb.Timestamp {
	if x != nil {
		return x.ReadAt
	}
	return nil
...
func (x *ApiMailboxEntry) GetClaimedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.ClaimedAt
	}
	return nil
...
func (x *ApiMailboxEntry) GetExpiresAt() *timestamppb.Timestamp {
	if x != nil {
		return x.ExpiresAt
	}
	return nil
...
// List the active character's mailbox.
type ListMailboxRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Optional status filter (UNSPECIFIED = all).
	Status MailboxStatus `protobuf:"varint,1,opt,name=status,proto3,enum=nakama.api.MailboxStatus" json:"status,omitempty"`
	// Max entries to return (server clamps; 0 = server default).
...
func (x *ListMailboxRequest) GetStatus() MailboxStatus {
	if x != nil {
		return x.Status
	}
	return MailboxStatus_MAILBOX_STATUS_UNSPECIFIED
...
func (x *ListMailboxRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *ListMailboxRequest) GetCursor() string {
	if x != nil {
		return x.Cursor
	}
	return ""
...
type ListMailboxResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Entries       []*ApiMailboxEntry     `protobuf:"bytes,1,rep,name=entries,proto3" json:"entries,omitempty"`
	NextCursor    string                 `protobuf:"bytes,2,opt,name=next_cursor,json=nextCursor,proto3" json:"next_cursor,omitempty"`
...
func (x *ListMailboxResponse) GetEntries() []*ApiMailboxEntry {
	if x != nil {
		return x.Entries
	}
	return nil
...
func (x *ListMailboxResponse) GetNextCursor() string {
	if x != nil {
		return x.NextCursor
	}
	return ""
...
func (x *ListMailboxResponse) GetUnreadCount() int32 {
	if x != nil {
...
type GetMailboxEntryRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetMailboxEntryRequest) Reset() {
	*x = GetMailboxEntryRequest{}
	mi := &file_api_proto_msgTypes[160]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetMailboxEntryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetMailboxEntryRequest) ProtoMessage() {}

func (x *GetMailboxEntryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[160]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetMailboxEntryRequest.ProtoReflect.Descriptor instead.
func (*GetMailboxEntryRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{160}
}

func (x *GetMailboxEntryRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
type GetMailboxEntryResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Entry         *ApiMailboxEntry       `protobuf:"bytes,1,opt,name=entry,proto3" json:"entry,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetMailboxEntryResponse) Reset() {
	*x = GetMailboxEntryResponse{}
	mi := &file_api_proto_msgTypes[161]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetMailboxEntryResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetMailboxEntryResponse) ProtoMessage() {}

func (x *GetMailboxEntryResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[161]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetMailboxEntryResponse.ProtoReflect.Descriptor instead.
func (*GetMailboxEntryResponse) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{161}
}

func (x *GetMailboxEntryResponse) GetEntry() *ApiMailboxEntry {
	if x != nil {
		return x.Entry
	}
	return nil
...
// Mark a mailbox entry as read.
type MarkMailboxReadRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *MarkMailboxReadRequest) Reset() {
	*x = MarkMailboxReadRequest{}
	mi := &file_api_proto_msgTypes[162]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MarkMailboxReadRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MarkMailboxReadRequest) ProtoMessage() {}

func (x *MarkMailboxReadRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[162]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MarkMailboxReadRequest.ProtoReflect.Descriptor instead.
func (*MarkMailboxReadRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{162}
}

func (x *MarkMailboxReadRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
type MarkMailboxReadResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Entry         *ApiMailboxEntry       `protobuf:"bytes,1,opt,name=entry,proto3" json:"entry,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *MarkMailboxReadResponse) Reset() {
	*x = MarkMailboxReadResponse{}
	mi := &file_api_proto_msgTypes[163]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MarkMailboxReadResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MarkMailboxReadResponse) ProtoMessage() {}

func (x *MarkMailboxReadResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[163]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MarkMailboxReadResponse.ProtoReflect.Descriptor instead.
func (*MarkMailboxReadResponse) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{163}
}

func (x *MarkMailboxReadResponse) GetEntry() *ApiMailboxEntry {
	if x != nil {
		return x.Entry
	}
	return nil
...
// Claim rewards on a single mailbox entry.
...
func (x *ClaimMailboxRequest) Reset() {
	*x = ClaimMailboxRequest{}
	mi := &file_api_proto_msgTypes[164]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ClaimMailboxRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClaimMailboxRequest) ProtoMessage() {}

func (x *ClaimMailboxRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[164]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClaimMailboxRequest.ProtoReflect.Descriptor instead.
func (*ClaimMailboxRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{164}
}

func (x *ClaimMailboxRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
type ClaimMailboxResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	Entry *ApiMailboxEntry       `protobuf:"bytes,1,opt,name=entry,proto3" json:"entry,omitempty"`
	// "" on success; "retrying" if grant is in-flight (HTTP 202).
	Status        string `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ClaimMailboxResponse) Reset() {
	*x = ClaimMailboxResponse{}
	mi := &file_api_proto_msgTypes[165]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ClaimMailboxResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClaimMailboxResponse) ProtoMessage() {}

func (x *ClaimMailboxResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[165]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClaimMailboxResponse.ProtoReflect.Descriptor instead.
func (*ClaimMailboxResponse) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{165}
}

func (x *ClaimMailboxResponse) GetEntry() *ApiMailboxEntry {
	if x != nil {
		return x.Entry
	}
	return nil
...
func (x *ClaimMailboxResponse) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
// Claim all claimable entries for the active character.
type ClaimAllMailboxRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ClaimAllMailboxRequest) Reset() {
	*x = ClaimAllMailboxRequest{}
	mi := &file_api_proto_msgTypes[166]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ClaimAllMailboxRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClaimAllMailboxRequest) ProtoMessage() {}

func (x *ClaimAllMailboxRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[166]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClaimAllMailboxRequest.ProtoReflect.Descriptor instead.
func (*ClaimAllMailboxRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{166}
}

type ClaimAllMailboxResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ClaimedCount  int32                  `protobuf:"varint,1,opt,name=claimed_count,json=claimedCount,proto3" json:"claimed_count,omitempty"`
	ClaimedIds    []string               `protobuf:"bytes,2,rep,name=claimed_ids,json=claimedIds,proto3" json:"claimed_ids,omitempty"`
	Status        string                 `protobuf:"bytes,3,opt,name=status,proto3" json:"status,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ClaimAllMailboxResponse) Reset() {
	*x = ClaimAllMailboxResponse{}
	mi := &file_api_proto_msgTypes[167]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ClaimAllMailboxResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClaimAllMailboxResponse) ProtoMessage() {}

func (x *ClaimAllMailboxResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[167]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClaimAllMailboxResponse.ProtoReflect.Descriptor instead.
func (*ClaimAllMailboxResponse) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{167}
}

func (x *ClaimAllMailboxResponse) GetClaimedCount() int32 {
	if x != nil {
...
func (x *ClaimAllMailboxResponse) GetClaimedIds() []string {
	if x != nil {
		return x.ClaimedIds
	}
	return nil
...
func (x *ClaimAllMailboxResponse) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
// Unread/claimable badge counts for the active character.
type MailboxBadgeRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *MailboxBadgeRequest) Reset() {
	*x = MailboxBadgeRequest{}
	mi := &file_api_proto_msgTypes[168]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MailboxBadgeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MailboxBadgeRequest) ProtoMessage() {}

func (x *MailboxBadgeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[168]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MailboxBadgeRequest.ProtoReflect.Descriptor instead.
func (*MailboxBadgeRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{168}
}

type MailboxBadgeResponse struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	UnreadCount    int32                  `protobuf:"varint,1,opt,name=unread_count,json=unreadCount,proto3" json:"unread_count,omitempty"`
	ClaimableCount int32                  `protobuf:"varint,2,opt,name=claimable_count,json=claimableCount,proto3" json:"claimable_count,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *MailboxBadgeResponse) Reset() {
	*x = MailboxBadgeResponse{}
	mi := &file_api_proto_msgTypes[169]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MailboxBadgeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MailboxBadgeResponse) ProtoMessage() {}

func (x *MailboxBadgeResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[169]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MailboxBadgeResponse.ProtoReflect.Descriptor instead.
func (*MailboxBadgeResponse) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{169}
}

func (x *MailboxBadgeResponse) GetUnreadCount() int32 {
	if x != nil {
		return x.UnreadCount
	}
	return 0
...
func (x *MailboxBadgeResponse) GetClaimableCount() int32 {
	if x != nil {
		return x.ClaimableCount
	}
	return 0
}

// Delete a mailbox entry (rejected if it has unclaimed rewards).
...
type FriendsOfFriendsList_FriendOfFriend struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The character who referred its friend.
...
func (x *FriendsOfFriendsList_FriendOfFriend) GetCharacter() *Character {
	if x != nil {
		return x.Character
	}
	return nil
...
// A single character-role pair.
type GroupCharacterList_GroupCharacter struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Character.
	Character *Character `protobuf:"bytes,1,opt,name=character,proto3" json:"character,omitempty"`
...
func (x *GroupCharacterList_GroupCharacter) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use GroupCharacterList_GroupCharacter.ProtoReflect.Descriptor instead.
func (*GroupCharacterList_GroupCharacter) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{48, 0}
}

func (x *GroupCharacterList_GroupCharacter) GetCharacter() *Character {
	if x != nil {
		return x.Character
	}
	return nil
...
func (x *GroupCharacterList_GroupCharacter) GetState() *wrapperspb.Int32Value {
	if x != nil {
		return x.State
	}
	return nil
...
type CharacterGroupList_CharacterGroup struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Group.
	Group *Group `protobuf:"bytes,1,opt,name=group,proto3" json:"group,omitempty"`
	// The character's relationship to the group.
	State         *wrapperspb.Int32Value `protobuf:"bytes,2,opt,name=state,proto3" json:"state,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CharacterGroupList_CharacterGroup) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use CharacterGroupList_CharacterGroup.ProtoReflect.Descriptor instead.
func (*CharacterGroupList_CharacterGroup) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{97, 0}
}

func (x *CharacterGroupList_CharacterGroup) GetGroup() *Group {
	if x != nil {
		return x.Group
	}
	return nil
...
func (x *CharacterGroupList_CharacterGroup) GetState() *wrapperspb.Int32Value {
	if x != nil {
		return x.State
	}
	return nil
...
const file_api_proto_rawDesc = "" +
	"\n" +
	"\tapi.proto\x12\n" +
	"nakama.api\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xb0\x03\n" +
	"\aAccount\x12$\n" +
	...
	"verifyTime\x12=\n" +
	"\fdisable_time\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\vdisableTime\x12D\n" +
	"\vauth_emails\x18\b \x03(\v2#.nakama.api.Account.AuthEmailsEntryR\n" +
	"authEmails\x1a=\n" +
	"\x0fAuthEmailsEntry\x12\x10\n" +
	...
	"\x19AddGroupCharactersRequest\x12\x19\n" +
	"\bgroup_id\x18\x01 \x01(\tR\agroupId\x12#\n" +
	"\rcharacter_ids\x18\x02 \x03(\tR\fcharacterIds\"\xa7\x01\n" +
	...
	"\x06create\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\x06create\x12\x1a\n" +
	"\busername\x18\x03 \x01(\tR\busername\x12.\n" +
	"\x04sync\x18\x04 \x01(\v2\x1a.google.protobuf.BoolValueR\x04sync\"/\n" +
	"\x17RequestEmailCodeRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\"\xe3\x01\n" +
	"\x1bAuthenticateEmailOTPRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x12\n" +
	"\x04code\x18\x02 \x01(\tR\x04code\x12\x1a\n" +
	"\busername\x18\x03 \x01(\tR\busername\x12E\n" +
	"\x04vars\x18\x04 \x03(\v21.nakama.api.AuthenticateEmailOTPRequest.VarsEntryR\x04vars\x1a7\n" +
	"\tVarsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x13LinkEmailOTPRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x12\n" +
	"\x04code\x18\x02 \x01(\tR\x04code\"[\n" +
	"\x19BanGroupCharactersRequest\x12\x19\n" +
	"\bgroup_id\x18\x01 \x01(\tR\agroupId\x12#\n" +
	...
	"\vuser_id_two\x18\r \x01(\tR\tuserIdTwo\x12\x1d\n" +
	"\n" +
	...
	"prevCursor\x12)\n" +
	"\x10cacheable_cursor\x18\x04 \x01(\tR\x0fcacheableCursor\"\xd4\x01\n" +
	...
	"\tmax_count\x18\x06 \x01(\x05R\bmaxCount\x12\x1d\n" +
	"\n" +
	"scope_type\x18\a \x01(\rR\tscopeType\">\n" +
	...
	"\rtournament_id\x18\x01 \x01(\tR\ftournamentId\"\x86\x01\n" +
	...
	"\fcharacter_id\x18\x04 \x01(\tR\vcharacterId\"_\n" +
	...
	"\x06Friend\x123\n" +
	"\tcharacter\x18\x01 \x01(\v2\x15.nakama.api.CharacterR\tcharacter\x121\n" +
	...
	"\x06cursor\x18\x02 \x01(\tR\x06cursor\"\xf0\x01\n" +
	...
	"\x06cursor\x18\x02 \x01(\tR\x06cursor\x1aa\n" +
	"\x0eFriendOfFriend\x12\x1a\n" +
	"\breferrer\x18\x01 \x01(\tR\breferrer\x123\n" +
	"\tcharacter\x18\x02 \x01(\v2\x15.nakama.api.CharacterR\tcharacter\"d\n" +
	...
	"\n" +
	"product_id\x18\x01 \x01(\tR\tproductId\"\xff\x03\n" +
	"\x05Group\x12\x0e\n" +
	...
	"updateTime\x12\x1d\n" +
	"\n" +
	"scope_type\x18\r \x01(\rR\tscopeType\x12\x19\n" +
	"\brealm_id\x18\x0e \x01(\tR\arealmId\x12\x1b\n" +
	"\tcohort_id\x18\x0f \x01(\tR\bcohortId\"N\n" +
	"\tGroupList\x12)\n" +
	"\x06groups\x18\x01 \x03(\v2\x11.nakama.api.GroupR\x06groups\x12\x16\n" +
	"\x06cursor\x18\x02 \x01(\tR\x06cursor\"\xc3\x02\n" +
	"\x12GroupCharacterList\x12X\n" +
	"\x10group_characters\x18\x01 \x03(\v2-.nakama.api.GroupCharacterList.GroupCharacterR\x0fgroupCharacters\x12\x16\n" +
	"\x06cursor\x18\x02 \x01(\tR\x06cursor\x1a\xba\x01\n" +
	"\x0eGroupCharacter\x123\n" +
	"\tcharacter\x18\x01 \x01(\v2\x15.nakama.api.CharacterR\tcharacter\x121\n" +
	...
	"\rtournament_id\x18\x01 \x01(\tR\ftournamentId\"\\\n" +
	"\x1aKickGroupCharactersRequest\x12\x19\n" +
	"\bgroup_id\x18\x01 \x01(\tR\agroupId\x12#\n" +
	"\rcharacter_ids\x18\x02 \x03(\tR\fcharacterIds\"\x82\x03\n" +
	...
	"\vcreate_time\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"createTime\x12$\n" +
	"\rauthoritative\x18\b \x01(\bR\rauthoritative\x12\x1d\n" +
	"\n" +
	"scope_type\x18\t \x01(\rR\tscopeType\x12\x19\n" +
	"\brealm_id\x18\n" +
	" \x01(\tR\arealmId\x12\x1b\n" +
	"\tcohort_id\x18\v \x01(\tR\bcohortId\"f\n" +
	"\x0fLeaderboardList\x12;\n" +
	"\fleaderboards\x18\x01 \x03(\v2\x17.nakama.api.LeaderboardR\fleaderboards\x12\x16\n" +
	"\x06cursor\x18\x02 \x01(\tR\x06cursor\"\xa7\x04\n" +
	...
	"\rmax_num_score\x18\f \x01(\rR\vmaxNumScore\x12\x19\n" +
	"\brealm_id\x18\r \x01(\tR\arealmId\x12!\n" +
	"\fcharacter_id\x18\x0e \x01(\tR\vcharacterId\"\xf5\x01\n" +
	...
	"\x04sync\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\x04sync\"\xfe\x01\n" +
	...
	"\brealm_id\x18\x05 \x01(\tR\arealmId\x12%\n" +
	"\x0einclude_global\x18\x06 \x01(\bR\rincludeGlobal\"\x92\x01\n" +
	...
	"\x06cursor\x18\x02 \x01(\tR\x06cursor\"\xf4\x02\n" +
	...
	"\x04open\x18\x06 \x01(\v2\x1a.google.protobuf.BoolValueR\x04open\x12;\n" +
	"\n" +
	"scope_type\x18\a \x01(\v2\x1c.google.protobuf.UInt32ValueR\tscopeType\x12A\n" +
	"\x0einclude_global\x18\b \x01(\v2\x1a.google.protobuf.BoolValueR\rincludeGlobal\"\xb0\x01\n" +
	...
	"\x0einclude_global\x18\x04 \x01(\bR\rincludeGlobal\"\xc2\x01\n" +
	...
	"\fcharacter_id\x18\x05 \x01(\tR\vcharacterId\"\xf5\x01\n" +
	"\x18ListSubscriptionsRequest\x121\n" +
	"\x05limit\x18\x01 \x01(\v2\x1b.google.protobuf.Int32ValueR\x05limit\x12\x16\n" +
	"\x06cursor\x18\x02 \x01(\tR\x06cursor\x12\x19\n" +
	"\brealm_id\x18\x03 \x01(\tR\arealmId\x12!\n" +
	"\fcharacter_id\x18\x04 \x01(\tR\vcharacterId\x12P\n" +
	"\x16include_account_scoped\x18\x05 \x01(\v2\x1a.google.protobuf.BoolValueR\x14includeAccountScoped\"\xea\x01\n" +
	...
	"\x05limit\x18\x03 \x01(\v2\x1b.google.protobuf.Int32ValueR\x05limit\x12\x16\n" +
	"\x06cursor\x18\x04 \x01(\tR\x06cursor\x123\n" +
	"\x06expiry\x18\x05 \x01(\v2\x1b.google.protobuf.Int64ValueR\x06expiry\"\xdf\x03\n" +
	...
	"\n" +
	"scope_type\x18\t \x01(\v2\x1c.google.protobuf.UInt32ValueR\tscopeType\x12A\n" +
	"\x0einclude_global\x18\n" +
	" \x01(\v2\x1a.google.protobuf.BoolValueR\rincludeGlobal\"\xbd\x01\n" +
	"\x1aListCharacterGroupsRequest\x12!\n" +
	"\fcharacter_id\x18\x01 \x01(\tR\vcharacterId\x121\n" +
	"\x05limit\x18\x02 \x01(\v2\x1b.google.protobuf.Int32ValueR\x05limit\x121\n" +
	"\x05state\x18\x03 \x01(\v2\x1b.google.protobuf.Int32ValueR\x05state\x12\x16\n" +
	"\x06cursor\x18\x04 \x01(\tR\x06cursor\"\xeb\x01\n" +
	"\x05Match\x12\x19\n" +
	...
	"\fhandler_name\x18\x06 \x01(\tR\vhandlerName\x12\x19\n" +
	"\bnode_url\x18\a \x01(\tR\anodeUrl\"8\n" +
	"\tMatchList\x12+\n" +
	...
	"\x1dPromoteGroupCharactersRequest\x12\x19\n" +
	"\bgroup_id\x18\x01 \x01(\tR\agroupId\x12#\n" +
	"\rcharacter_ids\x18\x02 \x03(\tR\fcharacterIds\"^\n" +
	...
	"\x06cursor\x18\x02 \x01(\tR\x06cursor\"\xba\x06\n" +
	"\n" +
	"Tournament\x12\x0e\n" +
	...
	"\rjoin_required\x18\x15 \x01(\bR\fjoinRequired\x12\x1d\n" +
	"\n" +
	"scope_type\x18\x16 \x01(\rR\tscopeType\x12\x19\n" +
	"\brealm_id\x18\x17 \x01(\tR\arealmId\x12\x1b\n" +
	"\tcohort_id\x18\x18 \x01(\tR\bcohortId\"b\n" +
	...
	"\x04open\x18\x06 \x01(\v2\x1a.google.protobuf.BoolValueR\x04open\"\xc7\x04\n" +
	"\x04User\x12\x0e\n" +
	...
	"updateTime\x127\n" +
	"\x18facebook_instant_game_id\x18\x10 \x01(\tR\x15facebookInstantGameId\x12\x19\n" +
	"\bapple_id\x18\x11 \x01(\tR\aappleId\"\xb7\x02\n" +
	"\x12CharacterGroupList\x12X\n" +
	"\x10character_groups\x18\x01 \x03(\v2-.nakama.api.CharacterGroupList.CharacterGroupR\x0fcharacterGroups\x12\x16\n" +
	"\x06cursor\x18\x02 \x01(\tR\x06cursor\x1a\xae\x01\n" +
	"\x0eCharacterGroup\x12'\n" +
	...
	"\apersist\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\apersist\"\x86\x05\n" +
	...
	"seenBefore\x12\x1d\n" +
	"\n" +
	"scope_type\x18\f \x01(\rR\tscopeType\x12\x19\n" +
	"\brealm_id\x18\r \x01(\tR\arealmId\x12!\n" +
	"\fcharacter_id\x18\x0e \x01(\tR\vcharacterId\"j\n" +
	...
	"\x16validated_subscription\x18\x01 \x01(\v2!.nakama.api.ValidatedSubscriptionR\x15validatedSubscription\"\x84\x06\n" +
	...
	"\x06active\x18\r \x01(\bR\x06active\x12\x1d\n" +
	"\n" +
	"scope_type\x18\x0e \x01(\rR\tscopeType\x12\x19\n" +
	"\brealm_id\x18\x0f \x01(\tR\arealmId\x12!\n" +
	"\fcharacter_id\x18\x10 \x01(\tR\vcharacterId\"\x97\x01\n" +
	"\fPurchaseList\x12N\n" +
	...
	"\x06cursor\x18\x02 \x01(\tR\x06cursor\"\xb7\x02\n" +
	"\x0eTransferPolicy\x12\x1d\n" +
	"\n" +
	"enabled_in\x18\x01 \x01(\bR\tenabledIn\x12\x1f\n" +
	"\venabled_out\x18\x02 \x01(\bR\n" +
	"enabledOut\x12%\n" +
	"\x0ecooldown_hours\x18\x03 \x01(\x05R\rcooldownHours\x12.\n" +
	"\x13blocked_source_tags\x18\x04 \x03(\tR\x11blockedSourceTags\x12.\n" +
	"\x13blocked_target_tags\x18\x05 \x03(\tR\x11blockedTargetTags\x12.\n" +
	"\x13require_source_tags\x18\x06 \x03(\tR\x11requireSourceTags\x12.\n" +
	"\x13require_target_tags\x18\a \x03(\tR\x11requireTargetTags\"\x80\x01\n" +
	"\vQueuePolicy\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12,\n" +
	"\x12max_capacity_ratio\x18\x02 \x01(\x01R\x10maxCapacityRatio\x12)\n" +
	"\x10priority_enabled\x18\x03 \x01(\bR\x0fpriorityEnabled\"\xb4\x01\n" +
	"\fNamingPolicy\x12\x16\n" +
	"\x06policy\x18\x01 \x01(\tR\x06policy\x12\x1d\n" +
	"\n" +
	"min_length\x18\x02 \x01(\x05R\tminLength\x12\x1d\n" +
	"\n" +
	"max_length\x18\x03 \x01(\x05R\tmaxLength\x12'\n" +
	"\x0fallowed_pattern\x18\x04 \x01(\tR\x0eallowedPattern\x12%\n" +
	"\x0ereserved_names\x18\x05 \x03(\tR\rreservedNames\"\xd7\x01\n" +
	"\fAccessPolicy\x12F\n" +
	"\x11allow_new_players\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x0fallowNewPlayers\x12'\n" +
	"\x0frequires_invite\x18\x02 \x01(\bR\x0erequiresInvite\x12*\n" +
	"\x11allowed_user_tags\x18\x04 \x03(\tR\x0fallowedUserTags\x12*\n" +
	"\x11blocked_user_tags\x18\x05 \x03(\tR\x0fblockedUserTags\"\xc0\x02\n" +
	"\rRealmPolicies\x126\n" +
	"\btransfer\x18\x01 \x01(\v2\x1a.nakama.api.TransferPolicyR\btransfer\x12-\n" +
	"\x05queue\x18\x02 \x01(\v2\x17.nakama.api.QueuePolicyR\x05queue\x120\n" +
	"\x06naming\x18\x03 \x01(\v2\x18.nakama.api.NamingPolicyR\x06naming\x120\n" +
	...
	"\x06status\x18\x06 \x01(\x0e2\x17.nakama.api.RealmStatusR\x06status\x12\x1f\n" +
	"\vmax_players\x18\a \x01(\x05R\n" +
	"maxPlayers\x12'\n" +
	"\x0fcurrent_players\x18\b \x01(\x05R\x0ecurrentPlayers\x12\x16\n" +
	...
	"\x05realm\x18\v \x01(\v2\x11.nakama.api.RealmR\x05realm\x12\x16\n" +
	...
	"\tRealmList\x12)\n" +
	"\x06realms\x18\x01 \x03(\v2\x11.nakama.api.RealmR\x06realms\"!\n" +
	"\x0fGetRealmRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"\x17\n" +
	"\x15ListCharactersRequest\"F\n" +
	"\rCharacterList\x125\n" +
	"\n" +
	...
	"\tcharacter\x18\x03 \x01(\v2\x15.nakama.api.CharacterR\tcharacter\"\xfa\x01\n" +
	"\x0fCharacterWallet\x12!\n" +
	"\fcharacter_id\x18\x01 \x01(\tR\vcharacterId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12\x19\n" +
	"\brealm_id\x18\x03 \x01(\tR\arealmId\x12\x16\n" +
	"\x06wallet\x18\x04 \x01(\tR\x06wallet\x12;\n" +
	"\vcreate_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"createTime\x12;\n" +
	"\vupdate_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"updateTime\">\n" +
	"\x19GetCharacterWalletRequest\x12!\n" +
	"\fcharacter_id\x18\x01 \x01(\tR\vcharacterId\"\xe7\x02\n" +
	"\x1cUpdateCharacterWalletRequest\x12!\n" +
	"\fcharacter_id\x18\x01 \x01(\tR\vcharacterId\x12U\n" +
	"\tchangeset\x18\x02 \x03(\v27.nakama.api.UpdateCharacterWalletRequest.ChangesetEntryR\tchangeset\x12R\n" +
	"\bmetadata\x18\x03 \x03(\v26.nakama.api.UpdateCharacterWalletRequest.MetadataEntryR\bmetadata\x1a<\n" +
	"\x0eChangesetEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xf4\x02\n" +
	"\x1dUpdateCharacterWalletResponse\x123\n" +
	"\x06wallet\x18\x01 \x01(\v2\x1b.nakama.api.CharacterWalletR\x06wallet\x12S\n" +
	"\bprevious\x18\x02 \x03(\v27.nakama.api.UpdateCharacterWalletResponse.PreviousEntryR\bprevious\x12P\n" +
	"\aupdated\x18\x03 \x03(\v26.nakama.api.UpdateCharacterWalletResponse.UpdatedEntryR\aupdated\x1a;\n" +
	"\rPreviousEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\x1a:\n" +
	"\fUpdatedEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"\x90\x04\n" +
	"\x15CharacterWalletLedger\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12!\n" +
	"\fcharacter_id\x18\x02 \x01(\tR\vcharacterId\x12\x17\n" +
	"\auser_id\x18\x03 \x01(\tR\x06userId\x12\x19\n" +
	"\brealm_id\x18\x04 \x01(\tR\arealmId\x12N\n" +
	"\tchangeset\x18\x05 \x03(\v20.nakama.api.CharacterWalletLedger.ChangesetEntryR\tchangeset\x12K\n" +
	"\bmetadata\x18\x06 \x03(\v2/.nakama.api.CharacterWalletLedger.MetadataEntryR\bmetadata\x12;\n" +
	"\vcreate_time\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"createTime\x12;\n" +
	"\vupdate_time\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"updateTime\x1a<\n" +
	...
	" ListCharacterWalletLedgerRequest\x12!\n" +
	"\fcharacter_id\x18\x01 \x01(\tR\vcharacterId\x121\n" +
	"\x05limit\x18\x02 \x01(\v2\x1b.google.protobuf.Int32ValueR\x05limit\x12\x16\n" +
	"\x06cursor\x18\x03 \x01(\tR\x06cursor\"\x8d\x01\n" +
	"\x19CharacterWalletLedgerList\x127\n" +
	"\x05items\x18\x01 \x03(\v2!.nakama.api.CharacterWalletLedgerR\x05items\x12\x16\n" +
	"\x06cursor\x18\x02 \x01(\tR\x06cursor\x12\x1f\n" +
	"\vprev_cursor\x18\x03 \x01(\tR\n" +
	"prevCursor\"\xf1\x01\n" +
	"\x14ListPurchasesRequest\x121\n" +
	"\x05limit\x18\x01 \x01(\v2\x1b.google.protobuf.Int32ValueR\x05limit\x12\x16\n" +
	"\x06cursor\x18\x02 \x01(\tR\x06cursor\x12\x19\n" +
	"\brealm_id\x18\x03 \x01(\tR\arealmId\x12!\n" +
	"\fcharacter_id\x18\x04 \x01(\tR\vcharacterId\x12P\n" +
	"\x16include_account_scoped\x18\x05 \x01(\v2\x1a.google.protobuf.BoolValueR\x14includeAccountScoped\"\xc7\x04\n" +
	"\x11CharacterTransfer\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12!\n" +
	"\fcharacter_id\x18\x02 \x01(\tR\vcharacterId\x12\x17\n" +
	"\auser_id\x18\x03 \x01(\tR\x06userId\x12&\n" +
	"\x0fsource_realm_id\x18\x04 \x01(\tR\rsourceRealmId\x12&\n" +
	"\x0ftarget_realm_id\x18\x05 \x01(\tR\rtargetRealmId\x12;\n" +
	"\x06status\x18\x06 \x01(\x0e2#.nakama.api.CharacterTransferStatusR\x06status\x12I\n" +
	"\finitiated_by\x18\a \x01(\x0e2&.nakama.api.CharacterTransferInitiatorR\vinitiatedBy\x12\x16\n" +
	...
	"\fcompleted_at\x18\r \x01(\v2\x1a.google.protobuf.TimestampR\vcompletedAt\"\x81\x01\n" +
	"\x18TransferCharacterRequest\x12!\n" +
	"\fcharacter_id\x18\x01 \x01(\tR\vcharacterId\x12&\n" +
	"\x0ftarget_realm_id\x18\x02 \x01(\tR\rtargetRealmId\x12\x1a\n" +
	"\bmetadata\x18\x03 \x01(\tR\bmetadata\"\x8b\x01\n" +
	"\x19TransferCharacterResponse\x129\n" +
	"\btransfer\x18\x01 \x01(\v2\x1d.nakama.api.CharacterTransferR\btransfer\x123\n" +
	"\tcharacter\x18\x02 \x01(\v2\x15.nakama.api.CharacterR\tcharacter\"\x8d\x01\n" +
	"\x1dListCharacterTransfersRequest\x12!\n" +
	"\fcharacter_id\x18\x01 \x01(\tR\vcharacterId\x121\n" +
	"\x05limit\x18\x02 \x01(\v2\x1b.google.protobuf.Int32ValueR\x05limit\x12\x16\n" +
	"\x06cursor\x18\x03 \x01(\tR\x06cursor\"l\n" +
	"\x15CharacterTransferList\x12;\n" +
	"\ttransfers\x18\x01 \x03(\v2\x1d.nakama.api.CharacterTransferR\ttransfers\x12\x16\n" +
	"\x06cursor\x18\x02 \x01(\tR\x06cursor\"g\n" +
	"\x1aTransferEligibilityRequest\x12!\n" +
	"\fcharacter_id\x18\x01 \x01(\tR\vcharacterId\x12&\n" +
	"\x0ftarget_realm_id\x18\x02 \x01(\tR\rtargetRealmId\"\xc2\x02\n" +
	"\x1bTransferEligibilityResponse\x12\x1a\n" +
	"\beligible\x18\x01 \x01(\bR\beligible\x12\x1a\n" +
	"\bblockers\x18\x02 \x03(\tR\bblockers\x12E\n" +
	...
	"\rscheduled_end\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\fscheduledEnd\x12=\n" +
	"\factual_start\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\vactualStart\x129\n" +
	"\n" +
	"actual_end\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\tactualEnd\x125\n" +
	"\x06status\x18\v \x01(\x0e2\x1d.nakama.api.MaintenanceStatusR\x06status\x12\x1f\n" +
	"\vallow_staff\x18\f \x01(\bR\n" +
	"allowStaff\x12-\n" +
	"\x12disconnect_players\x18\r \x01(\bR\x11disconnectPlayers\x128\n" +
	"\x18disconnect_grace_seconds\x18\x0e \x01(\x05R\x16disconnectGraceSeconds\x122\n" +
	"\x15notify_before_minutes\x18\x0f \x03(\x05R\x13notifyBeforeMinutes\x121\n" +
	"\x14notification_message\x18\x10 \x01(\tR\x13notificationMessage\x12\x1d\n" +
	"\n" +
	...
	"\n" +
	"group_type\x18\x05 \x01(\tR\tgroupType\x12\x1b\n" +
	"\trealm_ids\x18\x06 \x03(\tR\brealmIds\x12;\n" +
	"\vcreate_time\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"createTime\x12;\n" +
	"\vupdate_time\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"updateTime\x12@\n" +
	"\x0edefault_policy\x18\t \x01(\v2\x19.nakama.api.RealmPoliciesR\rdefaultPolicy\x12\x1a\n" +
	"\bmetadata\x18\n" +
	" \x01(\tR\bmetadata\"\xf1\x02\n" +
	"\bRealmBan\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12\x19\n" +
	"\brealm_id\x18\x03 \x01(\tR\arealmId\x12\x16\n" +
	"\x06reason\x18\x04 \x01(\tR\x06reason\x127\n" +
	"\tbanned_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\bbannedAt\x12\x1b\n" +
	"\tbanned_by\x18\x06 \x01(\tR\bbannedBy\x129\n" +
	"\n" +
	"expires_at\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\texpiresAt\x12;\n" +
	"\vunbanned_at\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"unbannedAt\x12\x1f\n" +
	"\vunbanned_by\x18\t \x01(\tR\n" +
	"unbannedBy\x12\x1a\n" +
	"\bmetadata\x18\n" +
	" \x01(\tR\bmetadata\"8\n" +
	"\x19RequestChangeEmailRequest\x12\x1b\n" +
	"\tnew_email\x18\x01 \x01(\tR\bnewEmail\"Q\n" +
	"\x19ConfirmChangeEmailRequest\x12\x19\n" +
	"\bold_code\x18\x01 \x01(\tR\aoldCode\x12\x19\n" +
	"\bnew_code\x18\x02 \x01(\tR\anewCode\"+\n" +
	"\x15RedeemGiftcodeRequest\x12\x12\n" +
	"\x04code\x18\x01 \x01(\tR\x04code\"\xd6\x01\n" +
	"\x16RedeemGiftcodeResponse\x12#\n" +
	...
	"campaignId\x12#\n" +
	"\rredemption_id\x18\x05 \x01(\tR\fredemptionIdJ\x04\b\x01\x10\x02R\x0ereward_payload\"\xbe\x01\n" +
	"\x13ApiRewardAttachment\x12\x12\n" +
	...
	"\bicon_url\x18\x06 \x01(\tR\aiconUrl\"\xc5\x04\n" +
	"\x0fApiMailboxEntry\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x18\n" +
	"\asubject\x18\x02 \x01(\tR\asubject\x12\x12\n" +
	"\x04body\x18\x03 \x01(\tR\x04body\x12\x1b\n" +
	"\timage_url\x18\x04 \x01(\tR\bimageUrl\x12A\n" +
	"\fmessage_type\x18\x05 \x01(\x0e2\x1e.nakama.api.MailboxMessageTypeR\vmessageType\x121\n" +
	"\x06status\x18\x06 \x01(\x0e2\x19.nakama.api.MailboxStatusR\x06status\x129\n" +
	"\arewards\x18\a \x03(\v2\x1f.nakama.api.ApiRewardAttachmentR\arewards\x12!\n" +
	"\fcharacter_id\x18\b \x01(\tR\vcharacterId\x12\x19\n" +
	"\brealm_id\x18\t \x01(\tR\arealmId\x12=\n" +
	"\fdelivered_at\x18\n" +
	...
	"\n" +
	"claimed_at\x18\f \x01(\v2\x1a.google.protobuf.TimestampR\tclaimedAt\x129\n" +
	"\n" +
	"expires_at\x18\r \x01(\v2\x1a.google.protobuf.TimestampR\texpiresAt\"u\n" +
	"\x12ListMailboxRequest\x121\n" +
	"\x06status\x18\x01 \x01(\x0e2\x19.nakama.api.MailboxStatusR\x06status\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\x05R\x05limit\x12\x16\n" +
	"\x06cursor\x18\x03 \x01(\tR\x06cursor\"\x90\x01\n" +
	"\x13ListMailboxResponse\x125\n" +
	"\aentries\x18\x01 \x03(\v2\x1b.nakama.api.ApiMailboxEntryR\aentries\x12\x1f\n" +
	"\vnext_cursor\x18\x02 \x01(\tR\n" +
	"nextCursor\x12!\n" +
	"\funread_count\x18\x03 \x01(\x05R\vunreadCount\"(\n" +
	"\x16GetMailboxEntryRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"L\n" +
	"\x17GetMailboxEntryResponse\x121\n" +
	"\x05entry\x18\x01 \x01(\v2\x1b.nakama.api.ApiMailboxEntryR\x05entry\"(\n" +
	"\x16MarkMailboxReadRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"L\n" +
	"\x17MarkMailboxReadResponse\x121\n" +
	"\x05entry\x18\x01 \x01(\v2\x1b.nakama.api.ApiMailboxEntryR\x05entry\"%\n" +
	"\x13ClaimMailboxRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"a\n" +
	"\x14ClaimMailboxResponse\x121\n" +
	"\x05entry\x18\x01 \x01(\v2\x1b.nakama.api.ApiMailboxEntryR\x05entry\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\"\x18\n" +
	"\x16ClaimAllMailboxRequest\"w\n" +
	"\x17ClaimAllMailboxResponse\x12#\n" +
	"\rclaimed_count\x18\x01 \x01(\x05R\fclaimedCount\x12\x1f\n" +
	"\vclaimed_ids\x18\x02 \x03(\tR\n" +
	"claimedIds\x12\x16\n" +
	"\x06status\x18\x03 \x01(\tR\x06status\"\x15\n" +
	"\x13MailboxBadgeRequest\"b\n" +
	"\x14MailboxBadgeResponse\x12!\n" +
	"\funread_count\x18\x01 \x01(\x05R\vunreadCount\x12'\n" +
	"\x0fclaimable_count\x18\x02 \x01(\x05R\x0eclaimableCount\"&\n" +
	"\x14DeleteMailboxRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"\x17\n" +
	"\x15DeleteMailboxResponse*o\n" +
	...
	"\tDECREMENT\x10\x04*\xb0\x01\n" +
	"\vRealmStatus\x12\x17\n" +
	"\x13REALM_STATUS_ACTIVE\x10\x00\x12\x1c\n" +
	"\x18REALM_STATUS_COMING_SOON\x10\x01\x12\x1c\n" +
	"\x18REALM_STATUS_MAINTENANCE\x10\x02\x12\x17\n" +
	"\x13REALM_STATUS_LOCKED\x10\x03\x12\x19\n" +
	"\x15REALM_STATUS_RETIRING\x10\x04\x12\x18\n" +
	"\x14REALM_STATUS_RETIRED\x10\x05*\x86\x01\n" +
	"\x0fCharacterStatus\x12\x1b\n" +
	...
	"\"CHARACTER_TRANSFER_INITIATOR_ADMIN\x10\x01*j\n" +
	"\x10MaintenanceScope\x12\x1b\n" +
	"\x17MAINTENANCE_SCOPE_REALM\x10\x00\x12\x1b\n" +
	"\x17MAINTENANCE_SCOPE_GROUP\x10\x01\x12\x1c\n" +
	"\x18MAINTENANCE_SCOPE_GLOBAL\x10\x02*\x98\x01\n" +
	"\x11MaintenanceStatus\x12 \n" +
	"\x1cMAINTENANCE_STATUS_SCHEDULED\x10\x00\x12\x1d\n" +
	"\x19MAINTENANCE_STATUS_ACTIVE\x10\x01\x12 \n" +
	"\x1cMAINTENANCE_STATUS_COMPLETED\x10\x02\x12 \n" +
	"\x1cMAINTENANCE_STATUS_CANCELLED\x10\x03*\xd4\x01\n" +
	"\rMailboxStatus\x12\x1e\n" +
	"\x1aMAILBOX_STATUS_UNSPECIFIED\x10\x00\x12\x19\n" +
	"\x15MAILBOX_STATUS_UNREAD\x10\x01\x12\x17\n" +
	"\x13MAILBOX_STATUS_READ\x10\x02\x12\x1b\n" +
	"\x17MAILBOX_STATUS_CLAIMING\x10\x03\x12\x1a\n" +
	"\x16MAILBOX_STATUS_CLAIMED\x10\x04\x12\x1a\n" +
	"\x16MAILBOX_STATUS_EXPIRED\x10\x05\x12\x1a\n" +
	"\x16MAILBOX_STATUS_DELETED\x10\x06*\xa3\x01\n" +
	"\x12MailboxMessageType\x12$\n" +
	" MAILBOX_MESSAGE_TYPE_UNSPECIFIED\x10\x00\x12\x1f\n" +
	"\x1bMAILBOX_MESSAGE_TYPE_SYSTEM\x10\x01\x12\x1f\n" +
	"\x1bMAILBOX_MESSAGE_TYPE_REWARD\x10\x02\x12%\n" +
	"!MAILBOX_MESSAGE_TYPE_ANNOUNCEMENT\x10\x03Bc\n" +
...
var file_api_proto_msgTypes = make([]protoimpl.MessageInfo, 200)
var file_api_proto_goTypes = []any{
	...
	(RealmStatus)(0),                                 // 3: nakama.api.RealmStatus
	(CharacterStatus)(0),                             // 4: nakama.api.CharacterStatus
	(CharacterTransferStatus)(0),                     // 5: nakama.api.CharacterTransferStatus
	(CharacterTransferInitiator)(0),                  // 6: nakama.api.CharacterTransferInitiator
	(MaintenanceScope)(0),                            // 7: nakama.api.MaintenanceScope
	(MaintenanceStatus)(0),                           // 8: nakama.api.MaintenanceStatus
	(MailboxStatus)(0),                               // 9: nakama.api.MailboxStatus
	(MailboxMessageType)(0),                          // 10: nakama.api.MailboxMessageType
	(Friend_State)(0),                                // 11: nakama.api.Friend.State
	(GroupCharacterList_GroupCharacter_State)(0),     // 12: nakama.api.GroupCharacterList.GroupCharacter.State
	(CharacterGroupList_CharacterGroup_State)(0),     // 13: nakama.api.CharacterGroupList.CharacterGroup.State
	(*Account)(nil),                                  // 14: nakama.api.Account
	(*AccountRefresh)(nil),                           // 15: nakama.api.AccountRefresh
	(*AccountApple)(nil),                             // 16: nakama.api.AccountApple
	(*AccountCustom)(nil),                            // 17: nakama.api.AccountCustom
	(*AccountDevice)(nil),                            // 18: nakama.api.AccountDevice
	(*AccountEmail)(nil),                             // 19: nakama.api.AccountEmail
	(*AccountFacebook)(nil),                          // 20: nakama.api.AccountFacebook
	(*AccountFacebookInstantGame)(nil),               // 21: nakama.api.AccountFacebookInstantGame
	(*AccountGameCenter)(nil),                        // 22: nakama.api.AccountGameCenter
	(*AccountGoogle)(nil),                            // 23: nakama.api.AccountGoogle
	(*AccountSteam)(nil),                             // 24: nakama.api.AccountSteam
	(*AddFriendsRequest)(nil),                        // 25: nakama.api.AddFriendsRequest
	(*AddGroupCharactersRequest)(nil),                // 26: nakama.api.AddGroupCharactersRequest
	(*SessionRefreshRequest)(nil),                    // 27: nakama.api.SessionRefreshRequest
	(*SessionLogoutRequest)(nil),                     // 28: nakama.api.SessionLogoutRequest
	(*AuthenticateAppleRequest)(nil),                 // 29: nakama.api.AuthenticateAppleRequest
	(*AuthenticateCustomRequest)(nil),                // 30: nakama.api.AuthenticateCustomRequest
	(*AuthenticateDeviceRequest)(nil),                // 31: nakama.api.AuthenticateDeviceRequest
	(*AuthenticateEmailRequest)(nil),                 // 32: nakama.api.AuthenticateEmailRequest
	(*AuthenticateFacebookRequest)(nil),              // 33: nakama.api.AuthenticateFacebookRequest
	(*AuthenticateFacebookInstantGameRequest)(nil),   // 34: nakama.api.AuthenticateFacebookInstantGameRequest
	(*AuthenticateGameCenterRequest)(nil),            // 35: nakama.api.AuthenticateGameCenterRequest
	(*AuthenticateGoogleRequest)(nil),                // 36: nakama.api.AuthenticateGoogleRequest
	(*AuthenticateSteamRequest)(nil),                 // 37: nakama.api.AuthenticateSteamRequest
	(*RequestEmailCodeRequest)(nil),                  // 38: nakama.api.RequestEmailCodeRequest
	(*AuthenticateEmailOTPRequest)(nil),              // 39: nakama.api.AuthenticateEmailOTPRequest
	(*VerifyEmailCodeRequest)(nil),                   // 40: nakama.api.VerifyEmailCodeRequest
	(*LinkEmailOTPRequest)(nil),                      // 41: nakama.api.LinkEmailOTPRequest
	(*BanGroupCharactersRequest)(nil),                // 42: nakama.api.BanGroupCharactersRequest
	(*BlockFriendsRequest)(nil),                      // 43: nakama.api.BlockFriendsRequest
	(*ChannelMessage)(nil),                           // 44: nakama.api.ChannelMessage
	(*ChannelMessageList)(nil),                       // 45: nakama.api.ChannelMessageList
	(*CreateGroupRequest)(nil),                       // 46: nakama.api.CreateGroupRequest
	(*DeleteFriendsRequest)(nil),                     // 47: nakama.api.DeleteFriendsRequest
	(*DeleteGroupRequest)(nil),                       // 48: nakama.api.DeleteGroupRequest
	(*DeleteLeaderboardRecordRequest)(nil),           // 49: nakama.api.DeleteLeaderboardRecordRequest
	(*DeleteNotificationsRequest)(nil),               // 50: nakama.api.DeleteNotificationsRequest
	(*DeleteTournamentRecordRequest)(nil),            // 51: nakama.api.DeleteTournamentRecordRequest
	(*DeleteStorageObjectId)(nil),                    // 52: nakama.api.DeleteStorageObjectId
	(*DeleteStorageObjectsRequest)(nil),              // 53: nakama.api.DeleteStorageObjectsRequest
	(*Event)(nil),                                    // 54: nakama.api.Event
	(*Friend)(nil),                                   // 55: nakama.api.Friend
	(*FriendList)(nil),                               // 56: nakama.api.FriendList
	(*FriendsOfFriendsList)(nil),                     // 57: nakama.api.FriendsOfFriendsList
	(*GetUsersRequest)(nil),                          // 58: nakama.api.GetUsersRequest
	(*GetSubscriptionRequest)(nil),                   // 59: nakama.api.GetSubscriptionRequest
	(*Group)(nil),                                    // 60: nakama.api.Group
	(*GroupList)(nil),                                // 61: nakama.api.GroupList
	(*GroupCharacterList)(nil),                       // 62: nakama.api.GroupCharacterList
	(*JoinGroupRequest)(nil),                         // 63: nakama.api.JoinGroupRequest
	(*JoinTournamentRequest)(nil),                    // 64: nakama.api.JoinTournamentRequest
	(*KickGroupCharactersRequest)(nil),               // 65: nakama.api.KickGroupCharactersRequest
	(*Leaderboard)(nil),                              // 66: nakama.api.Leaderboard
	(*LeaderboardList)(nil),                          // 67: nakama.api.LeaderboardList
	(*LeaderboardRecord)(nil),                        // 68: nakama.api.LeaderboardRecord
	(*LeaderboardRecordList)(nil),                    // 69: nakama.api.LeaderboardRecordList
	(*LeaveGroupRequest)(nil),                        // 70: nakama.api.LeaveGroupRequest
	(*LinkFacebookRequest)(nil),                      // 71: nakama.api.LinkFacebookRequest
	(*LinkSteamRequest)(nil),                         // 72: nakama.api.LinkSteamRequest
	(*ListChannelMessagesRequest)(nil),               // 73: nakama.api.ListChannelMessagesRequest
	(*ListFriendsRequest)(nil),                       // 74: nakama.api.ListFriendsRequest
	(*ListFriendsOfFriendsRequest)(nil),              // 75: nakama.api.ListFriendsOfFriendsRequest
	(*ListGroupsRequest)(nil),                        // 76: nakama.api.ListGroupsRequest
	(*ListGroupUsersRequest)(nil),                    // 77: nakama.api.ListGroupUsersRequest
	(*ListLeaderboardRecordsAroundOwnerRequest)(nil), // 78: nakama.api.ListLeaderboardRecordsAroundOwnerRequest
	(*ListLeaderboardRecordsRequest)(nil),            // 79: nakama.api.ListLeaderboardRecordsRequest
	(*ListMatchesRequest)(nil),                       // 80: nakama.api.ListMatchesRequest
	(*ListNotificationsRequest)(nil),                 // 81: nakama.api.ListNotificationsRequest
	(*ListStorageObjectsRequest)(nil),                // 82: nakama.api.ListStorageObjectsRequest
	(*ListSubscriptionsRequest)(nil),                 // 83: nakama.api.ListSubscriptionsRequest
	(*ListTournamentRecordsAroundOwnerRequest)(nil),  // 84: nakama.api.ListTournamentRecordsAroundOwnerRequest
	(*ListTournamentRecordsRequest)(nil),             // 85: nakama.api.ListTournamentRecordsRequest
	(*ListTournamentsRequest)(nil),                   // 86: nakama.api.ListTournamentsRequest
	(*ListCharacterGroupsRequest)(nil),               // 87: nakama.api.ListCharacterGroupsRequest
	(*Match)(nil),                                    // 88: nakama.api.Match
	(*MatchList)(nil),                                // 89: nakama.api.MatchList
	(*MatchmakerCompletionStats)(nil),                // 90: nakama.api.MatchmakerCompletionStats
	(*MatchmakerStats)(nil),                          // 91: nakama.api.MatchmakerStats
	(*Notification)(nil),                             // 92: nakama.api.Notification
	(*NotificationList)(nil),                         // 93: nakama.api.NotificationList
	(*PromoteGroupCharactersRequest)(nil),            // 94: nakama.api.PromoteGroupCharactersRequest
	(*DemoteGroupCharactersRequest)(nil),             // 95: nakama.api.DemoteGroupCharactersRequest
	(*ReadStorageObjectId)(nil),                      // 96: nakama.api.ReadStorageObjectId
	(*ReadStorageObjectsRequest)(nil),                // 97: nakama.api.ReadStorageObjectsRequest
	(*Rpc)(nil),                                      // 98: nakama.api.Rpc
	(*Session)(nil),                                  // 99: nakama.api.Session
	(*StorageObject)(nil),                            // 100: nakama.api.StorageObject
	(*StorageObjectAck)(nil),                         // 101: nakama.api.StorageObjectAck
	(*StorageObjectAcks)(nil),                        // 102: nakama.api.StorageObjectAcks
	(*StorageObjects)(nil),                           // 103: nakama.api.StorageObjects
	(*StorageObjectList)(nil),                        // 104: nakama.api.StorageObjectList
	(*Tournament)(nil),                               // 105: nakama.api.Tournament
	(*TournamentList)(nil),                           // 106: nakama.api.TournamentList
	(*TournamentRecordList)(nil),                     // 107: nakama.api.TournamentRecordList
	(*UpdateAccountRequest)(nil),                     // 108: nakama.api.UpdateAccountRequest
	(*UpdateGroupRequest)(nil),                       // 109: nakama.api.UpdateGroupRequest
	(*User)(nil),                                     // 110: nakama.api.User
	(*CharacterGroupList)(nil),                       // 111: nakama.api.CharacterGroupList
	(*Users)(nil),                                    // 112: nakama.api.Users
	(*ValidatePurchaseAppleRequest)(nil),             // 113: nakama.api.ValidatePurchaseAppleRequest
	(*ValidateSubscriptionAppleRequest)(nil),         // 114: nakama.api.ValidateSubscriptionAppleRequest
	(*ValidatePurchaseGoogleRequest)(nil),            // 115: nakama.api.ValidatePurchaseGoogleRequest
	(*ValidateSubscriptionGoogleRequest)(nil),        // 116: nakama.api.ValidateSubscriptionGoogleRequest
	(*ValidatePurchaseHuaweiRequest)(nil),            // 117: nakama.api.ValidatePurchaseHuaweiRequest
	(*ValidatePurchaseFacebookInstantRequest)(nil),   // 118: nakama.api.ValidatePurchaseFacebookInstantRequest
	(*ValidatedPurchase)(nil),                        // 119: nakama.api.ValidatedPurchase
	(*ValidatePurchaseResponse)(nil),                 // 120: nakama.api.ValidatePurchaseResponse
	(*ValidateSubscriptionResponse)(nil),             // 121: nakama.api.ValidateSubscriptionResponse
	(*ValidatedSubscription)(nil),                    // 122: nakama.api.ValidatedSubscription
	(*PurchaseList)(nil),                             // 123: nakama.api.PurchaseList
	(*SubscriptionList)(nil),                         // 124: nakama.api.SubscriptionList
	(*WriteLeaderboardRecordRequest)(nil),            // 125: nakama.api.WriteLeaderboardRecordRequest
	(*WriteStorageObject)(nil),                       // 126: nakama.api.WriteStorageObject
	(*WriteStorageObjectsRequest)(nil),               // 127: nakama.api.WriteStorageObjectsRequest
	(*WriteTournamentRecordRequest)(nil),             // 128: nakama.api.WriteTournamentRecordRequest
	(*ListPartiesRequest)(nil),                       // 129: nakama.api.ListPartiesRequest
	(*Party)(nil),                                    // 130: nakama.api.Party
	(*PartyList)(nil),                                // 131: nakama.api.PartyList
	(*TransferPolicy)(nil),                           // 132: nakama.api.TransferPolicy
	(*QueuePolicy)(nil),                              // 133: nakama.api.QueuePolicy
	(*NamingPolicy)(nil),                             // 134: nakama.api.NamingPolicy
	(*AccessPolicy)(nil),                             // 135: nakama.api.AccessPolicy
	(*RealmPolicies)(nil),                            // 136: nakama.api.RealmPolicies
	(*Realm)(nil),                                    // 137: nakama.api.Realm
	(*Character)(nil),                                // 138: nakama.api.Character
	(*ListRealmsRequest)(nil),                        // 139: nakama.api.ListRealmsRequest
	(*RealmList)(nil),                                // 140: nakama.api.RealmList
	(*GetRealmRequest)(nil),                          // 141: nakama.api.GetRealmRequest
	(*ListCharactersRequest)(nil),                    // 142: nakama.api.ListCharactersRequest
	(*CharacterList)(nil),                            // 143: nakama.api.CharacterList
	(*CreateCharacterRequest)(nil),                   // 144: nakama.api.CreateCharacterRequest
	(*UpdateCharacterRequest)(nil),                   // 145: nakama.api.UpdateCharacterRequest
	(*SelectCharacterRequest)(nil),                   // 146: nakama.api.SelectCharacterRequest
	(*SelectCharacterResponse)(nil),                  // 147: nakama.api.SelectCharacterResponse
	(*CharacterWallet)(nil),                          // 148: nakama.api.CharacterWallet
	(*GetCharacterWalletRequest)(nil),                // 149: nakama.api.GetCharacterWalletRequest
	(*UpdateCharacterWalletRequest)(nil),             // 150: nakama.api.UpdateCharacterWalletRequest
	(*UpdateCharacterWalletResponse)(nil),            // 151: nakama.api.UpdateCharacterWalletResponse
	(*CharacterWalletLedger)(nil),                    // 152: nakama.api.CharacterWalletLedger
	(*ListCharacterWalletLedgerRequest)(nil),         // 153: nakama.api.ListCharacterWalletLedgerRequest
	(*CharacterWalletLedgerList)(nil),                // 154: nakama.api.CharacterWalletLedgerList
	(*ListPurchasesRequest)(nil),                     // 155: nakama.api.ListPurchasesRequest
	(*CharacterTransfer)(nil),                        // 156: nakama.api.CharacterTransfer
	(*TransferCharacterRequest)(nil),                 // 157: nakama.api.TransferCharacterRequest
	(*TransferCharacterResponse)(nil),                // 158: nakama.api.TransferCharacterResponse
	(*ListCharacterTransfersRequest)(nil),            // 159: nakama.api.ListCharacterTransfersRequest
	(*CharacterTransferList)(nil),                    // 160: nakama.api.CharacterTransferList
	(*TransferEligibilityRequest)(nil),               // 161: nakama.api.TransferEligibilityRequest
	(*TransferEligibilityResponse)(nil),              // 162: nakama.api.TransferEligibilityResponse
	(*MaintenanceWindow)(nil),                        // 163: nakama.api.MaintenanceWindow
	(*RealmGroup)(nil),                               // 164: nakama.api.RealmGroup
	(*RealmBan)(nil),                                 // 165: nakama.api.RealmBan
	(*RequestChangeEmailRequest)(nil),                // 166: nakama.api.RequestChangeEmailRequest
	(*ConfirmChangeEmailRequest)(nil),                // 167: nakama.api.ConfirmChangeEmailRequest
	(*RedeemGiftcodeRequest)(nil),                    // 168: nakama.api.RedeemGiftcodeRequest
	(*RedeemGiftcodeResponse)(nil),                   // 169: nakama.api.RedeemGiftcodeResponse
	(*ApiRewardAttachment)(nil),                      // 170: nakama.api.ApiRewardAttachment
	(*ApiMailboxEntry)(nil),                          // 171: nakama.api.ApiMailboxEntry
	(*ListMailboxRequest)(nil),                       // 172: nakama.api.ListMailboxRequest
	(*ListMailboxResponse)(nil),                      // 173: nakama.api.ListMailboxResponse
	(*GetMailboxEntryRequest)(nil),                   // 174: nakama.api.GetMailboxEntryRequest
	(*GetMailboxEntryResponse)(nil),                  // 175: nakama.api.GetMailboxEntryResponse
	(*MarkMailboxReadRequest)(nil),                   // 176: nakama.api.MarkMailboxReadRequest
	(*MarkMailboxReadResponse)(nil),                  // 177: nakama.api.MarkMailboxReadResponse
	(*ClaimMailboxRequest)(nil),                      // 178: nakama.api.ClaimMailboxRequest
	(*ClaimMailboxResponse)(nil),                     // 179: nakama.api.ClaimMailboxResponse
	(*ClaimAllMailboxRequest)(nil),                   // 180: nakama.api.ClaimAllMailboxRequest
	(*ClaimAllMailboxResponse)(nil),                  // 181: nakama.api.ClaimAllMailboxResponse
	(*MailboxBadgeRequest)(nil),                      // 182: nakama.api.MailboxBadgeRequest
	(*MailboxBadgeResponse)(nil),                     // 183: nakama.api.MailboxBadgeResponse
	(*DeleteMailboxRequest)(nil),                     // 184: nakama.api.DeleteMailboxRequest
	(*DeleteMailboxResponse)(nil),                    // 185: nakama.api.DeleteMailboxResponse
	nil,                                              // 186: nakama.api.Account.AuthEmailsEntry
	nil,                                              // 187: nakama.api.AccountRefresh.VarsEntry
	nil,                                              // 188: nakama.api.AccountApple.VarsEntry
	nil,                                              // 189: nakama.api.AccountCustom.VarsEntry
	nil,                                              // 190: nakama.api.AccountDevice.VarsEntry
	nil,                                              // 191: nakama.api.AccountEmail.VarsEntry
	nil,                                              // 192: nakama.api.AccountFacebook.VarsEntry
	nil,                                              // 193: nakama.api.AccountFacebookInstantGame.VarsEntry
	nil,                                              // 194: nakama.api.AccountGameCenter.VarsEntry
	nil,                                              // 195: nakama.api.AccountGoogle.VarsEntry
	nil,                                              // 196: nakama.api.AccountSteam.VarsEntry
	nil,                                              // 197: nakama.api.SessionRefreshRequest.VarsEntry
	nil,                                              // 198: nakama.api.AuthenticateEmailOTPRequest.VarsEntry
	nil,                                              // 199: nakama.api.Event.PropertiesEntry
	(*FriendsOfFriendsList_FriendOfFriend)(nil),      // 200: nakama.api.FriendsOfFriendsList.FriendOfFriend
	(*GroupCharacterList_GroupCharacter)(nil),        // 201: nakama.api.GroupCharacterList.GroupCharacter
	(*CharacterGroupList_CharacterGroup)(nil),        // 202: nakama.api.CharacterGroupList.CharacterGroup
	(*WriteLeaderboardRecordRequest_LeaderboardRecordWrite)(nil), // 203: nakama.api.WriteLeaderboardRecordRequest.LeaderboardRecordWrite
	(*WriteTournamentRecordRequest_TournamentRecordWrite)(nil),   // 204: nakama.api.WriteTournamentRecordRequest.TournamentRecordWrite
	nil,                            // 205: nakama.api.Character.MetadataEntry
	nil,                            // 206: nakama.api.CreateCharacterRequest.MetadataEntry
	nil,                            // 207: nakama.api.UpdateCharacterRequest.MetadataEntry
	nil,                            // 208: nakama.api.UpdateCharacterWalletRequest.ChangesetEntry
	nil,                            // 209: nakama.api.UpdateCharacterWalletRequest.MetadataEntry
	nil,                            // 210: nakama.api.UpdateCharacterWalletResponse.PreviousEntry
	nil,                            // 211: nakama.api.UpdateCharacterWalletResponse.UpdatedEntry
	nil,                            // 212: nakama.api.CharacterWalletLedger.ChangesetEntry
	nil,                            // 213: nakama.api.CharacterWalletLedger.MetadataEntry
	(*timestamppb.Timestamp)(nil),  // 214: google.protobuf.Timestamp
	(*wrapperspb.BoolValue)(nil),   // 215: google.protobuf.BoolValue
	(*wrapperspb.Int32Value)(nil),  // 216: google.protobuf.Int32Value
	(*wrapperspb.StringValue)(nil), // 217: google.protobuf.StringValue
	(*wrapperspb.UInt32Value)(nil), // 218: google.protobuf.UInt32Value
	(*wrapperspb.Int64Value)(nil),  // 219: google.protobuf.Int64Value
}
var file_api_proto_depIdxs = []int32{
	110, // 0: nakama.api.Account.user:type_name -> nakama.api.User
	18,  // 1: nakama.api.Account.devices:type_name -> nakama.api.AccountDevice
	214, // 2: nakama.api.Account.verify_time:type_name -> google.protobuf.Timestamp
	214, // 3: nakama.api.Account.disable_time:type_name -> google.protobuf.Timestamp
	186, // 4: nakama.api.Account.auth_emails:type_name -> nakama.api.Account.AuthEmailsEntry
	187, // 5: nakama.api.AccountRefresh.vars:type_name -> nakama.api.AccountRefresh.VarsEntry
	188, // 6: nakama.api.AccountApple.vars:type_name -> nakama.api.AccountApple.VarsEntry
	189, // 7: nakama.api.AccountCustom.vars:type_name -> nakama.api.AccountCustom.VarsEntry
	190, // 8: nakama.api.AccountDevice.vars:type_name -> nakama.api.AccountDevice.VarsEntry
	191, // 9: nakama.api.AccountEmail.vars:type_name -> nakama.api.AccountEmail.VarsEntry
	192, // 10: nakama.api.AccountFacebook.vars:type_name -> nakama.api.AccountFacebook.VarsEntry
	193, // 11: nakama.api.AccountFacebookInstantGame.vars:type_name -> nakama.api.AccountFacebookInstantGame.VarsEntry
	194, // 12: nakama.api.AccountGameCenter.vars:type_name -> nakama.api.AccountGameCenter.VarsEntry
	195, // 13: nakama.api.AccountGoogle.vars:type_name -> nakama.api.AccountGoogle.VarsEntry
	196, // 14: nakama.api.AccountSteam.vars:type_name -> nakama.api.AccountSteam.VarsEntry
	197, // 15: nakama.api.SessionRefreshRequest.vars:type_name -> nakama.api.SessionRefreshRequest.VarsEntry
	16,  // 16: nakama.api.AuthenticateAppleRequest.account:type_name -> nakama.api.AccountApple
	215, // 17: nakama.api.AuthenticateAppleRequest.create:type_name -> google.protobuf.BoolValue
	17,  // 18: nakama.api.AuthenticateCustomRequest.account:type_name -> nakama.api.AccountCustom
	215, // 19: nakama.api.AuthenticateCustomRequest.create:type_name -> google.protobuf.BoolValue
	18,  // 20: nakama.api.AuthenticateDeviceRequest.account:type_name -> nakama.api.AccountDevice
	215, // 21: nakama.api.AuthenticateDeviceRequest.create:type_name -> google.protobuf.BoolValue
	19,  // 22: nakama.api.AuthenticateEmailRequest.account:type_name -> nakama.api.AccountEmail
	215, // 23: nakama.api.AuthenticateEmailRequest.create:type_name -> google.protobuf.BoolValue
	20,  // 24: nakama.api.AuthenticateFacebookRequest.account:type_name -> nakama.api.AccountFacebook
	215, // 25: nakama.api.AuthenticateFacebookRequest.create:type_name -> google.protobuf.BoolValue
	215, // 26: nakama.api.AuthenticateFacebookRequest.sync:type_name -> google.protobuf.BoolValue
	21,  // 27: nakama.api.AuthenticateFacebookInstantGameRequest.account:type_name -> nakama.api.AccountFacebookInstantGame
	215, // 28: nakama.api.AuthenticateFacebookInstantGameRequest.create:type_name -> google.protobuf.BoolValue
	22,  // 29: nakama.api.AuthenticateGameCenterRequest.account:type_name -> nakama.api.AccountGameCenter
	215, // 30: nakama.api.AuthenticateGameCenterRequest.create:type_name -> google.protobuf.BoolValue
	23,  // 31: nakama.api.AuthenticateGoogleRequest.account:type_name -> nakama.api.AccountGoogle
	215, // 32: nakama.api.AuthenticateGoogleRequest.create:type_name -> google.protobuf.BoolValue
	24,  // 33: nakama.api.AuthenticateSteamRequest.account:type_name -> nakama.api.AccountSteam
	215, // 34: nakama.api.AuthenticateSteamRequest.create:type_name -> google.protobuf.BoolValue
	215, // 35: nakama.api.AuthenticateSteamRequest.sync:type_name -> google.protobuf.BoolValue
	198, // 36: nakama.api.AuthenticateEmailOTPRequest.vars:type_name -> nakama.api.AuthenticateEmailOTPRequest.VarsEntry
	216, // 37: nakama.api.ChannelMessage.code:type_name -> google.protobuf.Int32Value
	214, // 38: nakama.api.ChannelMessage.create_time:type_name -> google.protobuf.Timestamp
	214, // 39: nakama.api.ChannelMessage.update_time:type_name -> google.protobuf.Timestamp
	215, // 40: nakama.api.ChannelMessage.persistent:type_name -> google.protobuf.BoolValue
	44,  // 41: nakama.api.ChannelMessageList.messages:type_name -> nakama.api.ChannelMessage
	52,  // 42: nakama.api.DeleteStorageObjectsRequest.object_ids:type_name -> nakama.api.DeleteStorageObjectId
	199, // 43: nakama.api.Event.properties:type_name -> nakama.api.Event.PropertiesEntry
	214, // 44: nakama.api.Event.timestamp:type_name -> google.protobuf.Timestamp
	138, // 45: nakama.api.Friend.character:type_name -> nakama.api.Character
	216, // 46: nakama.api.Friend.state:type_name -> google.protobuf.Int32Value
	214, // 47: nakama.api.Friend.update_time:type_name -> google.protobuf.Timestamp
	55,  // 48: nakama.api.FriendList.friends:type_name -> nakama.api.Friend
	200, // 49: nakama.api.FriendsOfFriendsList.friends_of_friends:type_name -> nakama.api.FriendsOfFriendsList.FriendOfFriend
	215, // 50: nakama.api.Group.open:type_name -> google.protobuf.BoolValue
	214, // 51: nakama.api.Group.create_time:type_name -> google.protobuf.Timestamp
	214, // 52: nakama.api.Group.update_time:type_name -> google.protobuf.Timestamp
	60,  // 53: nakama.api.GroupList.groups:type_name -> nakama.api.Group
	201, // 54: nakama.api.GroupCharacterList.group_characters:type_name -> nakama.api.GroupCharacterList.GroupCharacter
	2,   // 55: nakama.api.Leaderboard.operator:type_name -> nakama.api.Operator
	214, // 56: nakama.api.Leaderboard.create_time:type_name -> google.protobuf.Timestamp
	66,  // 57: nakama.api.LeaderboardList.leaderboards:type_name -> nakama.api.Leaderboard
	217, // 58: nakama.api.LeaderboardRecord.username:type_name -> google.protobuf.StringValue
	214, // 59: nakama.api.LeaderboardRecord.create_time:type_name -> google.protobuf.Timestamp
	214, // 60: nakama.api.LeaderboardRecord.update_time:type_name -> google.protobuf.Timestamp
	214, // 61: nakama.api.LeaderboardRecord.expiry_time:type_name -> google.protobuf.Timestamp
	68,  // 62: nakama.api.LeaderboardRecordList.records:type_name -> nakama.api.LeaderboardRecord
	68,  // 63: nakama.api.LeaderboardRecordList.owner_records:type_name -> nakama.api.LeaderboardRecord
	20,  // 64: nakama.api.LinkFacebookRequest.account:type_name -> nakama.api.AccountFacebook
	215, // 65: nakama.api.LinkFacebookRequest.sync:type_name -> google.protobuf.BoolValue
	24,  // 66: nakama.api.LinkSteamRequest.account:type_name -> nakama.api.AccountSteam
	215, // 67: nakama.api.LinkSteamRequest.sync:type_name -> google.protobuf.BoolValue
	216, // 68: nakama.api.ListChannelMessagesRequest.limit:type_name -> google.protobuf.Int32Value
	215, // 69: nakama.api.ListChannelMessagesRequest.forward:type_name -> google.protobuf.BoolValue
	216, // 70: nakama.api.ListFriendsRequest.limit:type_name -> google.protobuf.Int32Value
	216, // 71: nakama.api.ListFriendsRequest.state:type_name -> google.protobuf.Int32Value
	216, // 72: nakama.api.ListFriendsOfFriendsRequest.limit:type_name -> google.protobuf.Int32Value
	216, // 73: nakama.api.ListGroupsRequest.limit:type_name -> google.protobuf.Int32Value
	216, // 74: nakama.api.ListGroupsRequest.members:type_name -> google.protobuf.Int32Value
	215, // 75: nakama.api.ListGroupsRequest.open:type_name -> google.protobuf.BoolValue
	218, // 76: nakama.api.ListGroupsRequest.scope_type:type_name -> google.protobuf.UInt32Value
	215, // 77: nakama.api.ListGroupsRequest.include_global:type_name -> google.protobuf.BoolValue
	216, // 78: nakama.api.ListGroupUsersRequest.limit:type_name -> google.protobuf.Int32Value
	216, // 79: nakama.api.ListGroupUsersRequest.state:type_name -> google.protobuf.Int32Value
	218, // 80: nakama.api.ListLeaderboardRecordsAroundOwnerRequest.limit:type_name -> google.protobuf.UInt32Value
	219, // 81: nakama.api.ListLeaderboardRecordsAroundOwnerRequest.expiry:type_name -> google.protobuf.Int64Value
	216, // 82: nakama.api.ListLeaderboardRecordsRequest.limit:type_name -> google.protobuf.Int32Value
	219, // 83: nakama.api.ListLeaderboardRecordsRequest.expiry:type_name -> google.protobuf.Int64Value
	216, // 84: nakama.api.ListMatchesRequest.limit:type_name -> google.protobuf.Int32Value
	215, // 85: nakama.api.ListMatchesRequest.authoritative:type_name -> google.protobuf.BoolValue
	217, // 86: nakama.api.ListMatchesRequest.label:type_name -> google.protobuf.StringValue
	216, // 87: nakama.api.ListMatchesRequest.min_size:type_name -> google.protobuf.Int32Value
	216, // 88: nakama.api.ListMatchesRequest.max_size:type_name -> google.protobuf.Int32Value
	217, // 89: nakama.api.ListMatchesRequest.query:type_name -> google.protobuf.StringValue
	216, // 90: nakama.api.ListNotificationsRequest.limit:type_name -> google.protobuf.Int32Value
	216, // 91: nakama.api.ListStorageObjectsRequest.limit:type_name -> google.protobuf.Int32Value
	216, // 92: nakama.api.ListSubscriptionsRequest.limit:type_name -> google.protobuf.Int32Value
	215, // 93: nakama.api.ListSubscriptionsRequest.include_account_scoped:type_name -> google.protobuf.BoolValue
	218, // 94: nakama.api.ListTournamentRecordsAroundOwnerRequest.limit:type_name -> google.protobuf.UInt32Value
	219, // 95: nakama.api.ListTournamentRecordsAroundOwnerRequest.expiry:type_name -> google.protobuf.Int64Value
	216, // 96: nakama.api.ListTournamentRecordsRequest.limit:type_name -> google.protobuf.Int32Value
	219, // 97: nakama.api.ListTournamentRecordsRequest.expiry:type_name -> google.protobuf.Int64Value
	218, // 98: nakama.api.ListTournamentsRequest.category_start:type_name -> google.protobuf.UInt32Value
	218, // 99: nakama.api.ListTournamentsRequest.category_end:type_name -> google.protobuf.UInt32Value
	218, // 100: nakama.api.ListTournamentsRequest.start_time:type_name -> google.protobuf.UInt32Value
	218, // 101: nakama.api.ListTournamentsRequest.end_time:type_name -> google.protobuf.UInt32Value
	216, // 102: nakama.api.ListTournamentsRequest.limit:type_name -> google.protobuf.Int32Value
	218, // 103: nakama.api.ListTournamentsRequest.scope_type:type_name -> google.protobuf.UInt32Value
	215, // 104: nakama.api.ListTournamentsRequest.include_global:type_name -> google.protobuf.BoolValue
	216, // 105: nakama.api.ListCharacterGroupsRequest.limit:type_name -> google.protobuf.Int32Value
	216, // 106: nakama.api.ListCharacterGroupsRequest.state:type_name -> google.protobuf.Int32Value
	217, // 107: nakama.api.Match.label:type_name -> google.protobuf.StringValue
	88,  // 108: nakama.api.MatchList.matches:type_name -> nakama.api.Match
	214, // 109: nakama.api.MatchmakerCompletionStats.create_time:type_name -> google.protobuf.Timestamp
	214, // 110: nakama.api.MatchmakerCompletionStats.complete_time:type_name -> google.protobuf.Timestamp
	214, // 111: nakama.api.MatchmakerStats.oldest_ticket_create_time:type_name -> google.protobuf.Timestamp
	90,  // 112: nakama.api.MatchmakerStats.completions:type_name -> nakama.api.MatchmakerCompletionStats
	214, // 113: nakama.api.Notification.create_time:type_name -> google.protobuf.Timestamp
	92,  // 114: nakama.api.NotificationList.notifications:type_name -> nakama.api.Notification
	96,  // 115: nakama.api.ReadStorageObjectsRequest.object_ids:type_name -> nakama.api.ReadStorageObjectId
	214, // 116: nakama.api.StorageObject.create_time:type_name -> google.protobuf.Timestamp
	214, // 117: nakama.api.StorageObject.update_time:type_name -> google.protobuf.Timestamp
	214, // 118: nakama.api.StorageObjectAck.create_time:type_name -> google.protobuf.Timestamp
	214, // 119: nakama.api.StorageObjectAck.update_time:type_name -> google.protobuf.Timestamp
	101, // 120: nakama.api.StorageObjectAcks.acks:type_name -> nakama.api.StorageObjectAck
	100, // 121: nakama.api.StorageObjects.objects:type_name -> nakama.api.StorageObject
	100, // 122: nakama.api.StorageObjectList.objects:type_name -> nakama.api.StorageObject
	214, // 123: nakama.api.Tournament.create_time:type_name -> google.protobuf.Timestamp
	214, // 124: nakama.api.Tournament.start_time:type_name -> google.protobuf.Timestamp
	214, // 125: nakama.api.Tournament.end_time:type_name -> google.protobuf.Timestamp
	2,   // 126: nakama.api.Tournament.operator:type_name -> nakama.api.Operator
	105, // 127: nakama.api.TournamentList.tournaments:type_name -> nakama.api.Tournament
	68,  // 128: nakama.api.TournamentRecordList.records:type_name -> nakama.api.LeaderboardRecord
	68,  // 129: nakama.api.TournamentRecordList.owner_records:type_name -> nakama.api.LeaderboardRecord
	217, // 130: nakama.api.UpdateAccountRequest.username:type_name -> google.protobuf.StringValue
	217, // 131: nakama.api.UpdateAccountRequest.display_name:type_name -> google.protobuf.StringValue
	217, // 132: nakama.api.UpdateAccountRequest.avatar_url:type_name -> google.protobuf.StringValue
	217, // 133: nakama.api.UpdateAccountRequest.lang_tag:type_name -> google.protobuf.StringValue
	217, // 134: nakama.api.UpdateAccountRequest.location:type_name -> google.protobuf.StringValue
	217, // 135: nakama.api.UpdateAccountRequest.timezone:type_name -> google.protobuf.StringValue
	217, // 136: nakama.api.UpdateGroupRequest.name:type_name -> google.protobuf.StringValue
	217, // 137: nakama.api.UpdateGroupRequest.description:type_name -> google.protobuf.StringValue
	217, // 138: nakama.api.UpdateGroupRequest.lang_tag:type_name -> google.protobuf.StringValue
	217, // 139: nakama.api.UpdateGroupRequest.avatar_url:type_name -> google.protobuf.StringValue
	215, // 140: nakama.api.UpdateGroupRequest.open:type_name -> google.protobuf.BoolValue
	214, // 141: nakama.api.User.create_time:type_name -> google.protobuf.Timestamp
	214, // 142: nakama.api.User.update_time:type_name -> google.protobuf.Timestamp
	202, // 143: nakama.api.CharacterGroupList.character_groups:type_name -> nakama.api.CharacterGroupList.CharacterGroup
	110, // 144: nakama.api.Users.users:type_name -> nakama.api.User
	215, // 145: nakama.api.ValidatePurchaseAppleRequest.persist:type_name -> google.protobuf.BoolValue
	215, // 146: nakama.api.ValidateSubscriptionAppleRequest.persist:type_name -> google.protobuf.BoolValue
	215, // 147: nakama.api.ValidatePurchaseGoogleRequest.persist:type_name -> google.protobuf.BoolValue
	215, // 148: nakama.api.ValidateSubscriptionGoogleRequest.persist:type_name -> google.protobuf.BoolValue
	215, // 149: nakama.api.ValidatePurchaseHuaweiRequest.persist:type_name -> google.protobuf.BoolValue
	215, // 150: nakama.api.ValidatePurchaseFacebookInstantRequest.persist:type_name -> google.protobuf.BoolValue
	0,   // 151: nakama.api.ValidatedPurchase.store:type_name -> nakama.api.StoreProvider
	214, // 152: nakama.api.ValidatedPurchase.purchase_time:type_name -> google.protobuf.Timestamp
	214, // 153: nakama.api.ValidatedPurchase.create_time:type_name -> google.protobuf.Timestamp
	214, // 154: nakama.api.ValidatedPurchase.update_time:type_name -> google.protobuf.Timestamp
	214, // 155: nakama.api.ValidatedPurchase.refund_time:type_name -> google.protobuf.Timestamp
	1,   // 156: nakama.api.ValidatedPurchase.environment:type_name -> nakama.api.StoreEnvironment
	119, // 157: nakama.api.ValidatePurchaseResponse.validated_purchases:type_name -> nakama.api.ValidatedPurchase
	122, // 158: nakama.api.ValidateSubscriptionResponse.validated_subscription:type_name -> nakama.api.ValidatedSubscription
	0,   // 159: nakama.api.ValidatedSubscription.store:type_name -> nakama.api.StoreProvider
	214, // 160: nakama.api.ValidatedSubscription.purchase_time:type_name -> google.protobuf.Timestamp
	214, // 161: nakama.api.ValidatedSubscription.create_time:type_name -> google.protobuf.Timestamp
	214, // 162: nakama.api.ValidatedSubscription.update_time:type_name -> google.protobuf.Timestamp
	1,   // 163: nakama.api.ValidatedSubscription.environment:type_name -> nakama.api.StoreEnvironment
	214, // 164: nakama.api.ValidatedSubscription.expiry_time:type_name -> google.protobuf.Timestamp
	214, // 165: nakama.api.ValidatedSubscription.refund_time:type_name -> google.protobuf.Timestamp
	119, // 166: nakama.api.PurchaseList.validated_purchases:type_name -> nakama.api.ValidatedPurchase
	122, // 167: nakama.api.SubscriptionList.validated_subscriptions:type_name -> nakama.api.ValidatedSubscription
	203, // 168: nakama.api.WriteLeaderboardRecordRequest.record:type_name -> nakama.api.WriteLeaderboardRecordRequest.LeaderboardRecordWrite
	216, // 169: nakama.api.WriteStorageObject.permission_read:type_name -> google.protobuf.Int32Value
	216, // 170: nakama.api.WriteStorageObject.permission_write:type_name -> google.protobuf.Int32Value
	126, // 171: nakama.api.WriteStorageObjectsRequest.objects:type_name -> nakama.api.WriteStorageObject
	204, // 172: nakama.api.WriteTournamentRecordRequest.record:type_name -> nakama.api.WriteTournamentRecordRequest.TournamentRecordWrite
	216, // 173: nakama.api.ListPartiesRequest.limit:type_name -> google.protobuf.Int32Value
	215, // 174: nakama.api.ListPartiesRequest.open:type_name -> google.protobuf.BoolValue
	217, // 175: nakama.api.ListPartiesRequest.query:type_name -> google.protobuf.StringValue
	217, // 176: nakama.api.ListPartiesRequest.cursor:type_name -> google.protobuf.StringValue
	130, // 177: nakama.api.PartyList.parties:type_name -> nakama.api.Party
	215, // 178: nakama.api.AccessPolicy.allow_new_players:type_name -> google.protobuf.BoolValue
	132, // 179: nakama.api.RealmPolicies.transfer:type_name -> nakama.api.TransferPolicy
	133, // 180: nakama.api.RealmPolicies.queue:type_name -> nakama.api.QueuePolicy
	134, // 181: nakama.api.RealmPolicies.naming:type_name -> nakama.api.NamingPolicy
	135, // 182: nakama.api.RealmPolicies.access:type_name -> nakama.api.AccessPolicy
	3,   // 183: nakama.api.Realm.status:type_name -> nakama.api.RealmStatus
	214, // 184: nakama.api.Realm.create_time:type_name -> google.protobuf.Timestamp
	214, // 185: nakama.api.Realm.update_time:type_name -> google.protobuf.Timestamp
	136, // 186: nakama.api.Realm.policies:type_name -> nakama.api.RealmPolicies
	138, // 187: nakama.api.Realm.my_character:type_name -> nakama.api.Character
	205, // 188: nakama.api.Character.metadata:type_name -> nakama.api.Character.MetadataEntry
	4,   // 189: nakama.api.Character.status:type_name -> nakama.api.CharacterStatus
	214, // 190: nakama.api.Character.create_time:type_name -> google.protobuf.Timestamp
	214, // 191: nakama.api.Character.update_time:type_name -> google.protobuf.Timestamp
	214, // 192: nakama.api.Character.last_login_at:type_name -> google.protobuf.Timestamp
	137, // 193: nakama.api.Character.realm:type_name -> nakama.api.Realm
	216, // 194: nakama.api.ListRealmsRequest.status:type_name -> google.protobuf.Int32Value
	137, // 195: nakama.api.RealmList.realms:type_name -> nakama.api.Realm
	138, // 196: nakama.api.CharacterList.characters:type_name -> nakama.api.Character
	206, // 197: nakama.api.CreateCharacterRequest.metadata:type_name -> nakama.api.CreateCharacterRequest.MetadataEntry
	217, // 198: nakama.api.UpdateCharacterRequest.name:type_name -> google.protobuf.StringValue
	207, // 199: nakama.api.UpdateCharacterRequest.metadata:type_name -> nakama.api.UpdateCharacterRequest.MetadataEntry
	217, // 200: nakama.api.UpdateCharacterRequest.avatar:type_name -> google.protobuf.StringValue
	138, // 201: nakama.api.SelectCharacterResponse.character:type_name -> nakama.api.Character
	214, // 202: nakama.api.CharacterWallet.create_time:type_name -> google.protobuf.Timestamp
	214, // 203: nakama.api.CharacterWallet.update_time:type_name -> google.protobuf.Timestamp
	208, // 204: nakama.api.UpdateCharacterWalletRequest.changeset:type_name -> nakama.api.UpdateCharacterWalletRequest.ChangesetEntry
	209, // 205: nakama.api.UpdateCharacterWalletRequest.metadata:type_name -> nakama.api.UpdateCharacterWalletRequest.MetadataEntry
	148, // 206: nakama.api.UpdateCharacterWalletResponse.wallet:type_name -> nakama.api.CharacterWallet
	210, // 207: nakama.api.UpdateCharacterWalletResponse.previous:type_name -> nakama.api.UpdateCharacterWalletResponse.PreviousEntry
	211, // 208: nakama.api.UpdateCharacterWalletResponse.updated:type_name -> nakama.api.UpdateCharacterWalletResponse.UpdatedEntry
	212, // 209: nakama.api.CharacterWalletLedger.changeset:type_name -> nakama.api.CharacterWalletLedger.ChangesetEntry
	213, // 210: nakama.api.CharacterWalletLedger.metadata:type_name -> nakama.api.CharacterWalletLedger.MetadataEntry
	214, // 211: nakama.api.CharacterWalletLedger.create_time:type_name -> google.protobuf.Timestamp
	214, // 212: nakama.api.CharacterWalletLedger.update_time:type_name -> google.protobuf.Timestamp
	216, // 213: nakama.api.ListCharacterWalletLedgerRequest.limit:type_name -> google.protobuf.Int32Value
	152, // 214: nakama.api.CharacterWalletLedgerList.items:type_name -> nakama.api.CharacterWalletLedger
	216, // 215: nakama.api.ListPurchasesRequest.limit:type_name -> google.protobuf.Int32Value
	215, // 216: nakama.api.ListPurchasesRequest.include_account_scoped:type_name -> google.protobuf.BoolValue
	5,   // 217: nakama.api.CharacterTransfer.status:type_name -> nakama.api.CharacterTransferStatus
	6,   // 218: nakama.api.CharacterTransfer.initiated_by:type_name -> nakama.api.CharacterTransferInitiator
	214, // 219: nakama.api.CharacterTransfer.create_time:type_name -> google.protobuf.Timestamp
	214, // 220: nakama.api.CharacterTransfer.started_at:type_name -> google.protobuf.Timestamp
	214, // 221: nakama.api.CharacterTransfer.completed_at:type_name -> google.protobuf.Timestamp
	156, // 222: nakama.api.TransferCharacterResponse.transfer:type_name -> nakama.api.CharacterTransfer
	138, // 223: nakama.api.TransferCharacterResponse.character:type_name -> nakama.api.Character
	216, // 224: nakama.api.ListCharacterTransfersRequest.limit:type_name -> google.protobuf.Int32Value
	156, // 225: nakama.api.CharacterTransferList.transfers:type_name -> nakama.api.CharacterTransfer
	214, // 226: nakama.api.TransferEligibilityResponse.cooldown_expires:type_name -> google.protobuf.Timestamp
	137, // 227: nakama.api.TransferEligibilityResponse.source_realm:type_name -> nakama.api.Realm
	137, // 228: nakama.api.TransferEligibilityResponse.target_realm:type_name -> nakama.api.Realm
	7,   // 229: nakama.api.MaintenanceWindow.scope:type_name -> nakama.api.MaintenanceScope
	214, // 230: nakama.api.MaintenanceWindow.scheduled_start:type_name -> google.protobuf.Timestamp
	214, // 231: nakama.api.MaintenanceWindow.scheduled_end:type_name -> google.protobuf.Timestamp
	214, // 232: nakama.api.MaintenanceWindow.actual_start:type_name -> google.protobuf.Timestamp
	214, // 233: nakama.api.MaintenanceWindow.actual_end:type_name -> google.protobuf.Timestamp
	8,   // 234: nakama.api.MaintenanceWindow.status:type_name -> nakama.api.MaintenanceStatus
	214, // 235: nakama.api.MaintenanceWindow.create_time:type_name -> google.protobuf.Timestamp
	214, // 236: nakama.api.RealmGroup.create_time:type_name -> google.protobuf.Timestamp
	214, // 237: nakama.api.RealmGroup.update_time:type_name -> google.protobuf.Timestamp
	136, // 238: nakama.api.RealmGroup.default_policy:type_name -> nakama.api.RealmPolicies
	214, // 239: nakama.api.RealmBan.banned_at:type_name -> google.protobuf.Timestamp
	214, // 240: nakama.api.RealmBan.expires_at:type_name -> google.protobuf.Timestamp
	214, // 241: nakama.api.RealmBan.unbanned_at:type_name -> google.protobuf.Timestamp
	214, // 242: nakama.api.RedeemGiftcodeResponse.redeemed_at:type_name -> google.protobuf.Timestamp
	10,  // 243: nakama.api.ApiMailboxEntry.message_type:type_name -> nakama.api.MailboxMessageType
	9,   // 244: nakama.api.ApiMailboxEntry.status:type_name -> nakama.api.MailboxStatus
	170, // 245: nakama.api.ApiMailboxEntry.rewards:type_name -> nakama.api.ApiRewardAttachment
	214, // 246: nakama.api.ApiMailboxEntry.delivered_at:type_name -> google.protobuf.Timestamp
	214, // 247: nakama.api.ApiMailboxEntry.read_at:type_name -> google.protobuf.Timestamp
	214, // 248: nakama.api.ApiMailboxEntry.claimed_at:type_name -> google.protobuf.Timestamp
	214, // 249: nakama.api.ApiMailboxEntry.expires_at:type_name -> google.protobuf.Timestamp
	9,   // 250: nakama.api.ListMailboxRequest.status:type_name -> nakama.api.MailboxStatus
	171, // 251: nakama.api.ListMailboxResponse.entries:type_name -> nakama.api.ApiMailboxEntry
	171, // 252: nakama.api.GetMailboxEntryResponse.entry:type_name -> nakama.api.ApiMailboxEntry
	171, // 253: nakama.api.MarkMailboxReadResponse.entry:type_name -> nakama.api.ApiMailboxEntry
	171, // 254: nakama.api.ClaimMailboxResponse.entry:type_name -> nakama.api.ApiMailboxEntry
	138, // 255: nakama.api.FriendsOfFriendsList.FriendOfFriend.character:type_name -> nakama.api.Character
	138, // 256: nakama.api.GroupCharacterList.GroupCharacter.character:type_name -> nakama.api.Character
	216, // 257: nakama.api.GroupCharacterList.GroupCharacter.state:type_name -> google.protobuf.Int32Value
	60,  // 258: nakama.api.CharacterGroupList.CharacterGroup.group:type_name -> nakama.api.Group
	216, // 259: nakama.api.CharacterGroupList.CharacterGroup.state:type_name -> google.protobuf.Int32Value
	2,   // 260: nakama.api.WriteLeaderboardRecordRequest.LeaderboardRecordWrite.operator:type_name -> nakama.api.Operator
	2,   // 261: nakama.api.WriteTournamentRecordRequest.TournamentRecordWrite.operator:type_name -> nakama.api.Operator
